...
<head>
    ...
    <title>CORPORATE RH - LMS - Relatório de Aniversariantes</title>
...
<div class="container-fluid">
    ...
    <table class="aniversariante table table-condensed">
        <tr style='border-top: 3px solid #ddd;'>
            <th colspan="3" style="padding-top: 8px; text-align: center;">
                <h3 style="font-weight: bold;">RELATÓRIO DE ANIVERSARIANTES</h3>
            </th>
        </tr>
    </table>
    ...
    <table id="table" class="funcionarios table table-bordered table-condensed">
        ...
        <?php foreach ($funcionarios as $funcionario): ?>
            <tr>
                ...
                <td class="text-center" nowrap><?= $funcionario->data_nascimento ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
