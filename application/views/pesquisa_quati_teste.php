...
<head>
    ...
    <title>CORPORATE RH - LMS - Tipologia Junguiana</title>
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-file-text-o"></i><span
                                    class="hidden-xs hidden-sm"> Tipologia Junguiana</span>
                                                        ...
                                                        <?php foreach ($pergunta->alternativas as $alternativa): ?>
                                                            <tr>
                                                                <td>
                                                                    <div class="radio">
                                                                        <label>
                                                                            <?php echo form_radio(['name' => "resposta[$pergunta->id]", 'value' => $alternativa->id, 'checked' => $alternativa->resposta === $alternativa->peso, 'class' => "pergunta_$pergunta->id"]); ?>
...
<script>
    ...
    function enviar() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url('pesquisaQuati/finalizar/' . $this->uri->rsegment(3)); ?>',
            data: $('#form').serialize(),
            dataType: 'json',
            error: function () {
