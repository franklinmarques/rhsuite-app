...
<head>
    ...
    <title>CORPORATE RH - LMS - Teste de eneagrama</title>
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-file-text-o"></i><span
                                    class="hidden-xs hoidden-sm"> Teste de eneagrama</span>
                            ...
                            <?php else: ?>
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 text-center hidden-xs hidden-sm">
                                        <!--<h4>Tempo restante:</h4>
                                        <h1 id="tempo_restante"><?php /*echo $tempo_restante; */?></h1>-->
                                    </div>
...
<script>
    ...
    function enviar() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url('pesquisa_eneagrama/finalizar/' . $this->uri->rsegment(3)); ?>',
            data: $('#form').serialize(),
            dataType: 'json',
            error: function () {
