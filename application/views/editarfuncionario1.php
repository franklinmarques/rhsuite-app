			...
			<div class="col-md-12">
				...
				<section class="panel">
					...
					<div class="panel-body">
						...
						<script
							src="<?php echo base_url('assets/datatables/plugins/dataTables.rowsGroup.js'); ?>"></script>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-xs-5 controls">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="possui_apontamento_horas"
															   value="1"
															   <?= $possui_apontamento_horas ? 'checked' : ''; ?>>
										...
										<div class="form-group">
											...
											<div class="col-xs-10 controls">
												<div id="progresso" class="progress progress-mini pbar">
													<div
														class="progress-bar progress-bar-success ui-progressbar-value"
														style="width:0%"></div>
												</div>
											</div>
										</div>
