            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th>Requisição de pessoal</th>
                            <th>Tipo de vaga</th>
                            <th>Requisitante</th>
                            <th>Data início atividades</th>
                            <th>Início</th>
                            <th>Término</th>
                            <th>Status</th>
                            <th>Ações</th>
                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    <div class="row form-group">
                                        <label class="control-label col-md-2">N&ordm; Requisição</label>
                                        <div class="col-md-3">
                                            <input name="numero" class="form-control" type="number" min="0" step="1">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <label class="control-label col-md-2">Tipo vaga</label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="row form-group">
                                        <label class="control-label col-md-2">Nome requisitante</label>
                                        <div class="col-md-9">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('recrutamentoPresencial/ajax_list/' . $candidato) ?>",
                    "type": "POST",
                    "data": function (d) {
        ...
        function edit_teste(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('recrutamentoPresencial/ajax_edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function save() {
            ...
            var url;
            if (save_method === 'add') {
                url = "<?php echo site_url('recrutamentoPresencial/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('recrutamentoPresencial/ajax_update') ?>";
            }
        ...
        function delete_teste(id) {
            if (confirm('Deseja remover?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('recrutamentoPresencial/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data) {
