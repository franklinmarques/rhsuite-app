        ...
        <section class="wrapper">
            ...
            <table id="table" class="table table-striped table-bordered table-condensed" cellspacing="0"
                ...
                <tr class="success">
                    ...
                    <th colspan="5" class="text-center">Pesquisa</th>
                    <th colspan="4" class="text-center">Contratação</th>
                    <th colspan="5" class="text-center">Seleção</th>
                </tr>
                <tr>
                    ...
                    <th colspan="3" class="text-center">Exame Médico Admissional</th>
                    <th colspan="2" class="text-center" style="vertical-align: middle;">Contratar candidato</th>
                    <th colspan="2" class="text-center" style="vertical-align: middle;">Data admissão</th>

                    <th colspan="3" class="text-center">Testes online</th>
                ...
                <tr>
                    ...
                    <th>Data</th>
                    <th>
                        <button type="button" class="btn btn-info btn-sm"><i class="fa fa-envelope"></i></button>
                    </th>
                    <th>Resultado</th>
                    <th>Data</th>
                    <th>
                ...
                'columnDefs': [
                    ...
                    },
                    {
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            $(td).css('cursor', 'pointer');
                            $(td).on('click', function () {
                                $('#form_status .nome_candidato').html(rowData[30]);
                                $('#form_status [name="id"]').val(rowData[27]);
                                $('#form_status [name="status"]').val(rowData[29]);
