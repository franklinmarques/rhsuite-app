    ...
    <li class="sub-menu">
        ...
        <ul class="sub">
            ...
            <li <?php if (in_array($this->uri->segment(2), array('novofuncionario'))) echo 'class="active"'; ?>><a
                    ...
                    href="<?php echo base_url('home/novofuncionario'); ?>">Adicionar Funcionário</a></li>
            ...
            <li <?php if (in_array($this->uri->segment(2), array('funcionarios', 'cursosfuncionario', 'novocursofuncionario', 'editarfuncionario'))) echo 'class="active"'; ?>>
                ...
                <a href="<?php echo base_url('home/funcionarios'); ?>">Gerenciar Funcionários</a></li>
            ...
            <li <?php if (in_array($this->uri->segment(2), array('importarfuncionario'))) echo 'class="active"'; ?>><a
                    ...
                    href="<?php echo base_url('funcionario/importarFuncionario'); ?>">Importar Funcionários</a></li>
    ...
    <li class="sub-menu">
        ...
        <ul class="sub">
            ...
            <li <?php if (in_array($this->uri->segment(2), array('novocurso'))) echo 'class="active"'; ?>><a
                    ...
                    href="<?php echo base_url('home/novocurso'); ?>">Adicionar Treinamento</a></li>
            ...
            <li <?php if (in_array($this->uri->segment(2), array('cursos', 'paginascurso', 'novapaginacurso', 'editarpaginacurso', 'editarcurso'))) echo 'class="active"'; ?>>
                ...
                <a href="<?php echo base_url('home/cursos'); ?>">Gerenciar Treinamentos</a></li>
...
<?php if (!in_array($this->session->userdata('tipo'), array('administrador', 'funcionario'))) { ?>
    ...
    <li class="sub-menu">
        ...
        <ul class="sub">
            ...
            <li><a href="<?php echo base_url('home/paginaCargos'); ?>">Mapeamento de Competências</a></li>



            <li><a href="<?php echo base_url('home/paginaAvaliacao'); ?>">Aval. Desempenho P/ Competências</a></li>



            <li><a href="<?php echo base_url('home/manutencao'); ?>">Aval. Des. Período De Experiência</a></li>



            <li><a href="<?php echo base_url('home/manutencao'); ?>">Aval. Desempenho Por Resultados</a></li>

            

            <li><a href="<?php echo base_url('home/manutencao'); ?>">PDIs - Planos Desenv. Individuais</a></li>

            				
            <li><a href="<?php echo base_url('home/manutencao'); ?>">Gestão do Clima Organizacional</a></li>
