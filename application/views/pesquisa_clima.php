            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 5px; background-color: #eee;">
                        <li class="active">Clima Organizacional</li>
                    </ol>
                    <br/>
                    <div class="form-group hidden-md hidden-lg">
                        ...
                        <p>
                            ...
                            <small> Responder pesquisa de clima</small>
                        </p>
                        <hr>
                    </div>
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th>Pesquisa</th>
                            <th nowrap class="text-center">Data início</th>
                            <th nowrap class="text-center">Data término</th>
                            <th>Ação</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <table id="table_pesquisa" class="table table-striped table-condensed" cellspacing="0"
                                    ...
                                    <thead>
                                    <tr>
                                        <th colspan="3"><span id="instrucoes"></span></th>
                                    </tr>
                                    <tr>
                                        <th>Categoria</th>
...
?>
    ...
    <script>
        $(document).ready(function () {
            document.title = 'CORPORATE RH - LMS - Clima Organizacional';
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('pesquisa_clima/ajax_list/') ?>",
                    "type": "POST"
                },
                ...
                "drawCallback": function (settings) {
                    ...
                    api.column(0, {page: 'current'}).data().each(function (group, i) {
                        if (last !== group) {
                            ...
                            $(rows).eq(i).before(
                                '<tr class="group"><th colspan="2">' + group + '</th></tr>'
                            );
                            if (rowData[2] === null) {
                                $(rows).eq(i).before(
        ...
        function edit_pesquisa(id) {
            $.ajax({
                url: "<?php echo site_url('pesquisa_clima/ajax_edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function save() {
            ...
            $.ajax({
                url: "<?php echo site_url('pesquisa_clima/ajax_save') ?>",
                type: "POST",
                data: data,
                dataType: "JSON",
