        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                        <span><i class="fa fa-plus-square"></i> <strong> &nbsp;Cadastrar Página do Treinamento
                                - <?php echo $row->curso; ?></strong></span>
                    <a class="btn btn-default btn-sm"
                       href="<?php echo base_url('home/paginascurso/' . $row->id); ?>" style="float: right; margin-top: -0.6%;">
                        <i class="fa fa-reply"></i> &nbsp;&nbsp; Voltar
                    </a>
                </header>
                <div class="panel-body">
                    <div id="alert"></div>
                    <?php echo form_open('home/novapaginacurso_json/' . $row->id, 'data-aviso="alert" class="form-horizontal ajax-upload" '); ?>
                    <div class="col-lg-12">
                            ...
                            <tr>
                                <td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-9 controls">
                                                <label class="radio-inline">
                                                    <input type="radio" name="modulo" value="ckeditor" checked="checked">
                                                ...
                                                <label class="radio-inline">
                                                    ...
                                                    Vídeos e Links (Youtube, Vimeo, SlideShare, Dailymotion, URLs)
                                                </label>
                                                <!--
                                                <label class="radio-inline">
                                                    <input type="radio" name="modulo" value="links-externos" data-tipo="7">Links
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="arquivo_audio" name="arquivo_audio" type="hidden" readonly>
                                        ...
                                        <input id="arquivo_video" name="arquivo_video" type="hidden" readonly>
                                    </div>
                                    <!--
                                    <div class="col-md-8">
                        ...
                        <div id="box-arquivos-pdf" style="display: none;">
                            <div class="form-group">
                        ...
                        <div id="box-quiz" style="display: none;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <a href="#" id="adicionar-pergunta" class="btn btn-success btn-xs"><i
                                            class="fa fa-plus"></i> Adicionar Pergunta</a>
                                </div>
                            </div>
                            <div id="perguntas"></div>
                        </div>
                        <div id="box-atividades" style="display: none;">
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                    <a href="#" id="adicionar-pergunta-atividade" class="btn btn-success btn-xs"><i
                                            class="fa fa-plus"></i> Adicionar Pergunta</a>
                                </div>
                            </div>
                            <div id="perguntas-atividades"></div>
                        </div>
                        <div id="box-video-youtube" style="display: none;">
                            <div class="form-group">
                        ...
                        <div id="box-biblioteca" style="display: none;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 col-lg-2 controls">
                                    <select name="categoriabiblioteca" class="form-control input-sm">
                                        ...
                                        <?php foreach ($categoria->result() as $row_) { ?>
                                            <option
                                                value="<?php echo $row_->id; ?>"><?php echo $row_->curso; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-2 col-lg-2 controls">
                                    <input type="text" name="titulobiblioteca" placeholder="Título" value=""
                                           class="form-control input-sm"/>
                                </div>
                                <label class="col-sm-1 col-lg-1 control-label">Tags</label>

                                <div class="col-sm-2 col-lg-2 controls">
                                    <input type="text" name="tagsbiblioteca" placeholder="Tags" value=""
                                           class="form-control input-sm"/>
                                </div>
                                <div class="col-sm-2 col-lg-2">
                                    <a href="#" id="busca-biblioteca" class="btn btn-primary"><i
                                            class="glyphicon glyphfa fa-search"></i></a>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <video id="previewVideo" controls
                           style="border: 1px solid #000; height: 240px; width: 100%;" src="">
    ...
    $(function () {
        ...
        $('input[name=modulo]').click(function () {
            ...
            if (moduloSelecionado === 'biblioteca') {
                getBiblioteca($('#html-biblioteca'), '<?php echo base_url('home/getbiblioteca_html'); ?>/' + $('input[name=modulo]:checked').data('tipo'), $('select[name=categoriabiblioteca]').val(), $('input[name=titulobiblioteca]').val(), $('input[name=tagsbiblioteca]').val());
            }
        ...
        $('a[id*=adicionar-alternativa]').css('cursor', 'pointer').click(function () {
            ...
            html += '       Alternativa';
            html += '       <i class="glyphicon glyphfa fa-remove-circle remove-alternativa-' + aid + '" title="Remover" style="margin-left:2px; color:red;"></i>';
            html += '	</label>';
        ...
        $('#adicionar-pergunta').click(function () {
            ...
            html += '			Pergunta';
            html += '			<i class="glyphicon glyphfa fa-remove-circle remove-pergunta-' + pid + '" title="Remover" style="margin-left:2px; color:red;"></i>';
            html += '		</label>';
