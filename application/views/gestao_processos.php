                                ...
                                <div class="form-body">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="indicadores">
                                            ...
                                            <textarea name="indicadores" class="form-control"
                                                      rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="riscos_oportunidades">
                                            ...
                                            <textarea name="riscos_oportunidades" class="form-control"
                                                      rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="ocorrencias">
                                            ...
                                            <textarea name="ocorrencias" class="form-control"
                                                      rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="necessidades_investimentos">
                                            ...
                                            <textarea name="necessidades_investimentos" class="form-control"
                                                      rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="objetivos_futuros">
                                            ...
                                            <textarea name="objetivos_futuros" class="form-control"
                                                      rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="objetivos_imediatos">
                                            ...
                                            <textarea name="objetivos_imediatos" class="form-control"
                                                      rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="parecer_final">
                                            ...
                                            <textarea name="parecer_final" class="form-control" rows="12"></textarea>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="observacoes">
                                            ...
                                            <textarea name="observacoes" class="form-control" rows="12"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
