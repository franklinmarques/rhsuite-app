        ...
        function edit_processo(id) {
            ...
            $.ajax({
                ...
                'success': function (json) {
                    if (json.processo_1) {
                        $('#nome_processo_1').html('Nome do arquivo selecionado: <i>' + json.processo_1 + '</i>');
                    }
                    if (json.processo_1) {
                        $('#nome_processo_2').html('Nome do arquivo selecionado: <i>' + json.processo_2 + '</i>');
                    }
                    if (json.documentacao_2) {
                        $('#nome_documentacao_1').html('Nome do arquivo selecionado: <i>' + json.documentacao_1 + '</i>');
                    }
                    if (json.documentacao_2) {
                        $('#nome_documentacao_2').html('Nome do arquivo selecionado: <i>' + json.documentacao_2 + '</i>');
                    }
