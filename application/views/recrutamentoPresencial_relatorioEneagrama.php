...
?>
                    ...
                    <tr style='border-top: 5px solid #ddd;'>
                        ...
                        <td class="text-right">
                            <a id="pdf" class="btn btn-sm btn-danger"
                               href="<?= site_url('recrutamentoPresencial/pdfEneagrama/' . $this->uri->rsegment(3)); ?>"
    ...
    <script>
        ...
        function gerarRelatorio() {
            ...
            $.ajax({
                url: "<?= site_url('recrutamentoPresencial/pdfEneagrama/' . $this->uri->rsegment(3)); ?>",
                type: "POST",
                dataType: "json",
                data: {
                ...
                success: function (dat) {
                    location.href = '<?= site_url('recrutamentoPresencial/downloadPdf'); ?>/' + dat.pacote;
                    setTimeout(function () {
