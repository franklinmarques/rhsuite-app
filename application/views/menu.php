            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a href="<?php echo site_url('atividades'); ?>"
                       class="<?= (in_array($this->uri->rsegment(2), array('', 'atividades')) ? 'active' : ''); ?>">
                ...
                <?php if (in_array($this->session->userdata('tipo'), array('empresa'))) : ?>
                    <li class="sub-menu">
                        <a href="javascript:void(0);"
                            <?= (in_array($this->uri->rsegment(2), array('home', 'funcionarios', 'cursosfuncionario', 'novocursofuncionario', 'novofuncionario', 'editarfuncionario', 'importarFuncionario')) ? ' class="active"' : ''); ?>>
                ...
                <?php if (in_array($this->session->userdata('tipo'), array('empresa'))) : ?>
                    <li class="sub-menu">
                        <a href="javascript:void(0);"
                            <?= (in_array($this->uri->rsegment(1), array('recrutamento', 'recrutamento_modelos', 'recrutamento_questoes', 'recrutamento_cargos', 'recrutamento_processos', 'recrutamento_candidatos')) ? ' class="active"' : ''); ?>>
                            <i class="fa fa-user-plus"></i>
                            <span>Processos Seletivos</span>
                        </a>
                        <ul class="sub">
                            <li class="<?php echo(in_array($this->uri->rsegment(1), array('recrutamento_modelos', 'recrutamento_questoes')) ? 'active' : ''); ?>">
                                <a href="<?php echo site_url('recrutamento_modelos'); ?>">Modelos para Teste de
                                    Seleção</a></li>
                            <li class="<?php echo(in_array($this->uri->rsegment(1), array('recrutamento', 'recrutamento_cargos', 'recrutamento_processos')) ? 'active' : ''); ?>">
                                <a href="<?php echo site_url('recrutamento'); ?>">Gestão de Processos Seletivos</a></li>
                            <li class="<?php echo(in_array($this->uri->rsegment(1), array('recrutamento_candidatos')) ? 'active' : ''); ?>">
                                <a href="<?php echo site_url('recrutamento_candidatos'); ?>">Gerenciar Candidatos</a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li class="sub-menu">
                ...
                <?php if (in_array($this->session->userdata('tipo'), array('administrador', 'empresa'))) : ?>
                    <li class="sub-menu">
                        <a href="javascript:;"<?= (in_array($this->uri->rsegment(1), array('cursos', 'treinamento', 'funcionarios', 'paginascurso', 'novapaginacurso', 'editarpaginacurso', 'novocurso', 'editarcurso')) ? ' class="active"' : ''); ?>>
                            <i class="fa fa-graduation-cap"></i>
                            <span>Programas de Capacitação</span>
                        </a>
                        <ul class="sub">
                            <li<?= (in_array($this->uri->rsegment(2), array('novo')) ? ' class="active"' : ''); ?>>
                            ...
                            <li<?= (in_array($this->uri->rsegment(2), array('index', 'cursos', 'paginascurso', 'novapaginacurso', 'editarpaginacurso', 'editarcurso')) ? ' class="active"' : ''); ?>>
                            ...
                            <li<?= (($this->uri->rsegment(1) == 'funcionarios' or $this->uri->rsegment(2) == 'status') ? ' class="active"' : ''); ?>>
                                <!--<a href="<?php //echo site_url('home/cursos');                                                     ?>">Gerenciar treinamentos</a></li>-->
