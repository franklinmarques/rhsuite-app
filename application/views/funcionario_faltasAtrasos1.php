...
<div class="row">
    <div class="col-md-12">
        <button class="btn btn-info" onclick="add_falta_atraso()"><i class="glyphicon glyphicon-plus"></i> Adicionar
            nova falta ou atraso
        </button>
        <br/>
        <br/>
        <table id="table_falta_atraso" class="table table-striped table-bordered"
...
<!-- Bootstrap modal -->
<div class="modal fade" id="modal_falta_atraso" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h3 class="modal-title">Formulario de Faltas/Atrasos</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form_falta_atraso" class="form-horizontal">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSaveFaltaAtraso" onclick="save_falta_atraso()" class="btn btn-success">
                    Salvar
                </button>
...
<script>
    ...
    //datatables
    table = $('#table_falta_atraso').DataTable({
    ...
    function delete_falta_atraso(id) {
