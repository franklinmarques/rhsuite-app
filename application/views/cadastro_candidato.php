                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="dados_cadastrais">
                            <div class="row">
                                <div class="col col-md-12">
                                    <?php echo form_open('vagas/salvarCurriculo/' . $codigo, 'data-aviso="alert" class="form-horizontal ajax-upload autocomplete="off"'); ?>
                        ...
                        <div role="tabpanel" class="tab-pane" id="formacao">
                            ...
                            <fieldset>
                                ...
                                <input type="hidden" name="id[7]" value="">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Curso 1</label>
                                    <div class="col-sm-4 controls">
                                ...
                                <hr>
                                <input type="hidden" name="id[8]" value="">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Curso 2</label>
                                    <div class="col-sm-4 controls">
                                ...
                                <hr>
                                <input type="hidden" name="id[9]" value="">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Curso 3</label>
                                    <div class="col-sm-4 controls">
                            ...
                            <fieldset>
                                ...
                                <input type="hidden" name="id[10]" value="">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Curso 1</label>
                                    <div class="col-sm-4 controls">
                                ...
                                <hr>
                                <input type="hidden" name="id[12]" value="">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Curso 3</label>
                                    <div class="col-sm-4 controls">
