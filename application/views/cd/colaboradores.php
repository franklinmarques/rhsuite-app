                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <div class="btn-group" role="group" aria-label="...">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-default" onclick="$('select').val('')">Limpar filtros</button>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <p><label></label></p>
                                    <a id="pdf" class="btn btn-sm btn-danger" href="<?= site_url('apontamento_colaboradores/pdf/'); ?>" title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
