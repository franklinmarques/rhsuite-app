...
<div class="container-fluid">
                ...
                <?php if ($is_pdf == false): ?>
                    <td nowrap>
                        <a id="pdf" class="btn btn-sm btn-danger"
                           href="<?= site_url('cd/relatorios/pdf/' . $query_string); ?>"
    ...
    <div>
        ...
        <table id="funcionarios" class="table table-bordered table-condensed">
            <thead>
            <tr class="success">
                <th colspan="<?= ($postos ? 3 : 0) + $dias + 6 ?>" class="text-center"><h3><strong>Medição de
                            funcionários</strong></h3></th>
            </tr>
            <tr class="active">
                <th rowspan="2" class="text-center text-nowrap" style="vertical-align: middle;">Escola</th>
                <th rowspan="2" class="text-center text-nowrap" style="vertical-align: middle;">Funcionário(a)</th>
                <th rowspan="2" class="text-center text-nowrap" style="vertical-align: middle;">P</th>
                <th colspan="<?= $dias ?>" class="text-center text-nowrap">Dias com eventos de apontamento</th>
            </tr>
            <tr class="active">
            ...
            <?php foreach ($apontamentos as $apontamento): ?>
                <tr>
                    ...
                    <?php for ($i = 1; $i <= $dias; $i++): ?>
                        ...
                        <td class="text-center date-width-success"><?php eval('echo $apontamento->dia_' . $dia . ';'); ?></td>
                    <?php endfor; ?>
                </tr>
            <?php endforeach; ?>
            </tbody>
...
<script>
    $('[name="calculo_totalizacao"]').on('change', function () {
        ...
        $('#pdf').prop('href', "<?= site_url('cd/relatorios/pdf'); ?>/" + search.join('&'));
    });
</script>
</body>
</html>