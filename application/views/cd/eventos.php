            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a id="pdf" style="float: right;" class="btn btn-sm btn-danger"
                       href="<?= site_url('cd/eventos/pdf/'); ?>" title="Exportar PDF"><i
                            ...
                            <div class="well well-sm">
                                <form action="#" id="busca" class="form-horizontal" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label class="control-label">Filtrar por período</label><br>
                                            <label class="checkbox-inline">
                                                <input id="periodo_manha" name="periodo_manha" value="M" type="checkbox"
                                                       class="busca"> Manhã
                                            </label>
                                            <label class="checkbox-inline">
                                                <input id="periodo_tarde" name="periodo_tarde" value="T" type="checkbox"
                                                       class="busca"> Tarde
                                            </label>
                                            <label class="checkbox-inline">
                                                <input id="periodo_noite" name="periodo_noite" value="N" type="checkbox"
                                                       class="busca"> Noite
                                            </label>
                                        </div>
...
?>
    ...
    <script>
                        ...
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            switch (rowData[col]) {
                                ...
                                case 'EM':
                                    ...
                                    break;
                                case 'PC':
                                    $(td).addClass('date-width-primary').prop('title', 'PC - Posto coberto');
                                    break;
                                case 'ID':
        ...
        function setPdf_atributes() {
            ...
            $('#pdf').prop('href', "<?= site_url('cd/eventos/pdf/'); ?>" + search);
        }
