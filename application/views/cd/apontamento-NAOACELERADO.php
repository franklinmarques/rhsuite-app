                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <?php if (in_array($this->session->userdata('nivel'), array(0, 7, 8, 9))): ?>
                                            <li><a href="diretorias">Contratos/Diretorias</a></li>
                                        <?php endif; ?>
                                        ...
                                        <?php if (in_array($this->session->userdata('nivel'), array(0, 7, 8, 9, 10))): ?>
                                            ...
                                            <li><a href="supervisores">Vincular supervisores</a></li>
                                        <?php endif; ?>
                                        <li><a href="cuidadores">Vincular cuidadores</a></li>
                                        <li><a href="eventos">Relatório de eventos</a></li>
                                    </ul>
                                </div>
                            <?php endif; ?>
                        </div>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li><a href="<?= site_url('cd/relatorios/index/'); ?>" id="pdf"
                                                   target="_blank"><i class="glyphicon glyphicon-list text-info"></i>
                                            ...
                                            <li><a href="<?= site_url('cd/relatorios/pdfCuidadores/'); ?>"
                                                   id="pdfCuidadores"><i class="glyphicon glyphicon-list text-info"></i>
                                ...
                                <div role="tabpanel" class="tab-pane" id="alunos">
                                    <table id="table_cuidadores"
                                        ...
                                        <tr>
                                            ...
                                            <!--                                            <th class="warning" style="vertical-align: middle;">P</th>-->
                                            <th class="warning" style="vertical-align: middle;">Aluno(a)</th>
                                            <th class="warning">Hipótese diagnóstica</th>
                                            <!-- <th class="warning" style="text-align: left;">Valor do VT</th>
                                            <th class="warning">Cartão utilizado</th> -->
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <form action="#" id="busca" class="form-horizontal" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php echo form_dropdown('supervisor', $supervisor, $supervisor_atual, 'onchange="atualizarFiltro();" class="form-control input-sm"'); ?>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form_colaborador" class="form-horizontal">
                                <div class="form-body">
                                    ...
                                    <!-- <div class="row form-group">
                                    <label class="control-label col-md-2">Cuidador(a)</label>
                                    <div class="col-md-9">
                                        <?php //echo form_dropdown('id_vinculado', $id_alocado, '', 'class="form-control" autocomplete="off"'); ?>
                                        <span class="help-block"></span>
                                    </div>
                                </div> -->
                                    <div class="row form-group">
                                        ...
                                        <!--<div class="col-md-2">
                                            <input name="dia" id="dia" placeholder="dd"
                                                   class="form-control text-right" maxlength="2" type="number">
                                            <span class="help-block"></span>
                                        </div>-->
                                        <div class="col-md-3">
...
?>
    ...
    <script>
        ...
        var table, table_funcionarios, table_cuidadores, table_frequencias, table_colaboradores;
        var busca;
                        ...
                        "createdCell": function (td, cellData, rowData, row, col) {
                            if (rowData[5] === null) {
                                ...
                                $(td).on('click', function () {
                                    ...
                                    // $('#form_frequencias [name="id_aluno"]').val(rowData[0]);
                                    // $('#form_frequencias [name="escola"]').val(rowData[2]);
                                    // $('#form_frequencias [name="supervisor"]').val(rowData[3]);
                                    // $('#form_frequencias [name="turno"]').val(rowData[4]);
                                    ...
                                    console.log(col, $(table_frequencias.column(col).header()).data('mes_ano'));
                                    //$('#form_frequencias [name="status"][value="AF"]').prop('checked', $(td).data('status') === 'AF');
                                ...
                                /*if (rowData[col][7] === 'FA') {
                                 ...
                                 $(td).addClass('date-width-danger');
                                 } else if (rowData[col][7] === 'FE') {
                                 $(td).addClass('date-width-primary');
                                 } else if (rowData[col][7] === 'EM') {
                                 $(td).addClass('date-width-info');
                                 } else if (rowData[col][7] === 'AD') {
                                 $(td).addClass('date-width-success');
                                 } else if (rowData[col][7] === 'AF') {
                                 $(td).css('background-color', '#fff');
                                 } else if (rowData[col][0].length > 0) {
                                 $(td).css('background-color', '#ff0');
                                 } else if ($(table_frequencias.column(col).header()).hasClass('text-danger') == false) {
                                 $(td).addClass('date-width-success');
                                 //$(td).css('background-color', '#dff0d8');
                                 }*/
                                /*$(td).attr({
                                 'data-tooltip': 'tooltip',
                                 'data-placement': 'top',
                                 'title': rowData[1] + '\n' + $(table_frequencias.column(col).header()).attr('title') +
                                 '\nEvento: ' + (rowData[col][7] === 'AA' ? 'Aluno ausente' :
                                 rowData[col][7] === 'FA' ? 'Falta com atestado' :
                                 rowData[col][7] === 'FS' ? 'Falta sem atestado' :
                                 rowData[col][7] === 'AF' ? 'Funcionário afastado' :
                                 rowData[col][7] === 'EM' ? 'Emenda feriado' :
                                 rowData[col][7] === 'FE' ? 'Feriado' : 'Ok') +
                                 (rowData[col][1] !== '' && rowData[col][1] !== undefined ? '\nSubstituto(a): ' + rowData[col][8] : '') +
                                 (rowData[col][6] !== '' && rowData[col][6] !== undefined ? '\nObservações: ' + rowData[col][6] : '')
                                 }); */
                                //$(td).html(rowData[col][2] !== undefined ? rowData[col][2] : '');
                                if (rowData[col][2] !== undefined) {
                                    if (rowData[col][1].length > 0) {
                                        //$(td).css({'background-color': '#d9534f ', 'color': '#fff'}).html(rowData[col][1]);
                ...
                "columnDefs": [
                    {
                        "createdCell": function (td, cellData, rowData, row, col) {
                            if (rowData[1] === null) {
                                $(td).addClass('text-danger text-nowrap').html(rowData[col]);
                            } else {
                                $(td).removeClass('text-danger text-nowrap').html(rowData[col]);
                            }
                        },
                        className: "warning",
                        'targets': [0]
        ...
        function edit_frequencia(id_frequencia) {
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    $('#btnLimparfrequencia').attr('disabled', id_frequencia.length === 0);
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    alert('Error get data from ajax');
                }
...
//                    atualizarColaboradores();
        ...
        function reload_table(reset = false) {
            ...
            if ('<?= $modo_privilegiado ?>') {
                table_funcionarios.ajax.reload(stmt, reset); //reload datatable ajax
            } else {
                count = count + 1;
            }
            table_cuidadores.ajax.reload(stmt, reset); //reload datatable ajax
            table_frequencias.ajax.reload(stmt, reset); //reload datatable ajax
