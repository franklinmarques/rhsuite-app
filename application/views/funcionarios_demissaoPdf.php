...
<head>
    ...
    <title>CORPORATE RH - LMS - Relatório de Demissões</title>
...
<div class="container-fluid">
    ...
    <table class="demissao table table-condensed">
        <tr style='border-top: 3px solid #ddd;'>
            <th colspan="3" style="padding-top: 8px; text-align: center;">
                <h3 style="font-weight: bold;">RELATÓRIO DE DEMISSÕES</h3>
            </th>
        </tr>
    </table>
    ...
    <table id="table" class="funcionarios table table-bordered table-condensed">
        ...
        <?php foreach ($funcionarios as $funcionario): ?>
            <tr>
                ...
                <td class="text-center" nowrap><?= $funcionario->data_demissao ?></td>
                <td><?= $funcionario->tipo_demissao ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
