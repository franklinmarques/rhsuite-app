                                            ...
                                            <div class="panel panel-default" style="border: 1px solid #999">
                                                ...
                                                <div class="panel-body">
                                                    <object id="panel-manual" type="image/png"
                                                            data="<?= site_url('recrutamentoPresencial_testes/texto_exemplo/' . $this->uri->rsegment(3)) ?>"
...
<script>
    ...
    //                $.ajax({
    //                    url: "<?php echo site_url('recrutamentoPresencial_testes/texto/') ?>/",
    //                    type: "POST",
    //                    dataType: "JSON",
    //                    data: {
    //                        estado: $(this).val()
    ...
    function enviar() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url('recrutamentoPresencial_testes/finalizar/' . $this->uri->rsegment(3)); ?>',
            data: $('#form').serialize(),
            dataType: 'json',
            error: function () {
