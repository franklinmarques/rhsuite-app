            ...
            <div class="col-md-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-file-o"></i> Cadastrar Documento - Colaborador
                    </header>
                    <div class="panel-body">
                        <?php echo form_open('documento/documentoColaborador_db', 'data-aviso="alert" class="form-horizontal ajax-upload" enctype="multipart/form-data"'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="hidden" id="colaborador" name="colaborador" value="<?= ($this->uri->rsegment(3) > 0 ? $this->uri->rsegment(3) : $this->uri->rsegment(4)); ?>">
