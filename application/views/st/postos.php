                            ...
                            <form action="#" id="busca" class="form-horizontal" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <?php echo form_dropdown('depto', $depto, '', 'onchange="atualizar_filtro()" class="form-control input-sm filtro"'); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Filtrar por área/cliente</label>
                                        <?php echo form_dropdown('area', $area, '', 'onchange="atualizar_filtro()" class="form-control input-sm filtro"'); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Filtrar por setor/unidade</label>
                                        <?php echo form_dropdown('setor', $setor, '', 'onchange="atualizar_filtro()" class="form-control input-sm filtro"'); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Filtrar por cargo</label>
                                        <?php echo form_dropdown('cargo', $cargo, '', 'onchange="atualizar_filtro()" class="form-control input-sm filtro"'); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="control-label">Filtrar por função</label>
                                        <?php echo form_dropdown('funcao', $funcao, '', 'onchange="atualizar_filtro()" class="form-control input-sm filtro"'); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Filtrar por contrato</label>
                                        <?php echo form_dropdown('contrato', $contrato, '', 'onchange="reload_table();" class="form-control input-sm filtro"'); ?>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input name="busca_ano" placeholder="aaaa" class="form-control ano input-sm"
                                               type="text" onchange="reload_table();">
                                    </div>
                                    <div class="col-md-1">
                                        <label>&nbsp;</label><br>
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" id="calcular_valor" class="btn btn-default">Calcular
                                            valores
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-md-5 form-inline">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="valor_dia" type="text" style="width: 120px;"
                                                   class="form-control valor text-right"
                                                   aria-describedby="basic-addon1">
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        document.title = 'CORPORATE RH - LMS - Gerenciar Postos';
    });
</script>
...
<script>
    ...
    function atualizar_filtro() {
        ...
        $.ajax({
            'url': '<?php echo site_url('st/postos/atualizarFiltro') ?>',
            'type': 'POST',
            'dataType': 'json',
            'data': data,
            'beforeSend': function () {
            ...
            'success': function (json) {
                $.each(json, function (key, value) {
                    $('#busca [name="' + key + '"]').html($(value).html());
                });
    ...
    function get_posto_anterior() {
        $.ajax({
            'url': '<?php echo site_url('st/postos/clonarAnterior') ?>',
            'type': 'POST',
            'dataType': 'json',
            'data': {'id_usuario': $('[name="id_usuario"]').val()},
            'beforeSend': function () {
                $('#copiar_posto').text('Copiando valores do posto anterior...').attr('disabled', true);
            },
            'success': function (json) {
                if (json.erro) {
                    alert(json.erro);
            ...
            'complete': function () {
                $('#copiar_posto').text('Copiar valores do posto anterior').attr('disabled', false);
            }
        });
    }
