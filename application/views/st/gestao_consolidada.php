        ...
        <table id="table" class="table table-condensed">
            ...
            <tr>
                ...
                <td style="width: 100%; vertical-align: top;">
                    <p>
                        <img src="<?= base_url('imagens/usuarios/' . $empresa->foto_descricao) ?>" align="left" style="height: auto; width: auto; max-height: 92px; max-width: 508px; vertical-align: middle; padding: 0 10px 5px 5px;">
                ...
                <th colspan="<?= $is_pdf == false ? '3' : '2' ?>" style="padding-bottom: 8px; text-align: center;">
                    <?php if ($is_pdf == false): ?>
                        ...
                        <?php if ($contrato): ?>
                            ...
                            <?= $contrato->nome ?> ─ <?= $contrato->area ?></h4>
                        <?php endif; ?>
                    <?php else: ?>
                        ...
                        <?php if ($contrato): ?>
                            <h5 class="text-center" style="font-weight: bold;">
                                <?= $contrato->nome ?> ─ <?= $contrato->area ?></h5>
                        <?php endif; ?>
                    <?php endif; ?>
                </th>
            </tr>
...
<script>
    ...
    var pdf = "<?= site_url('apontamento_gestao_consolidada/pdf/' . $query_string); ?>";
    var busca;
    ...
    $(document).ready(function () {
        ...
        table_colaboradores = $('#table_colaboradores').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "*/<?php //echo site_url('apontamento_gestao_consolidada/ajax_colaboradores') ?>/*",
                "type": "POST",
                timeout: 90000,
                data: function (d) {
                    d.busca = busca;
        ...
        table_tempo = $('#table_tempo').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "*/<?php //echo site_url('apontamento_gestao_consolidada/ajax_tempo') ?>/*",
                "type": "POST",
                timeout: 90000,
                data: function (d) {
                    d.busca = busca;
        ...
        */
        ...
        table_faltas = $('#table_faltas').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo site_url('apontamento_gestao_consolidada/ajax_faltas') ?>",
                "type": "POST",
                timeout: 90000,
                data: function (d) {
                    d.busca = busca;
        ...
        table_valores = $('#table_financas').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo site_url('apontamento_gestao_consolidada/ajax_valores') ?>",
                "type": "POST",
                timeout: 90000,
                data: function (d) {
                    d.busca = busca;
        ...
        table_turnover = $('#table_turnover').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo site_url('apontamento_gestao_consolidada/ajax_turnover') ?>",
                "type": "POST",
                timeout: 90000,
                data: function (d) {
                    d.busca = busca;
...
//            } else 
        ...
        //$('#pdf').prop('href', "<?php // site_url('apontamento_gestao_consolidada/pdf/'); ?>" + search);
        pdf = "<?= site_url('apontamento_gestao_consolidada/pdf/'); ?>" + search;
    }
    ...
    function gerarRelatorio() {
        ...
        $.ajax({
            ...
            success: function(dat){
                location.href = '<?= site_url('apontamento_gestao_consolidada/downloadPdf'); ?>/' + dat.pacote;
                setTimeout(function(){ 
