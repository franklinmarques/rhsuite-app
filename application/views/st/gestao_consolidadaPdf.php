            ...
            <tr style='border-top: 5px solid #ddd;'>
                <th colspan="<?= $is_pdf == false ? '3' : '2' ?>" style="padding-bottom: 8px; text-align: center;">
                    <?php if ($is_pdf == false): ?>
                        ...
                        <?php if ($contrato): ?>
                            <h4 class="text-center" style="font-weight: bold;"><?= $contrato->nome ?>
                                ─ <?= $contrato->area ?></h4>
                        <?php endif; ?>
                    <?php else: ?>
                        <h4 class="text-center" style="font-weight: bold;">RELATÓRIO DE CONSOLIDAÇÃO FINANCEIRA</h4>
                        <?php if ($contrato): ?>
                            <h5 class="text-center" style="font-weight: bold;"><?= $contrato->nome ?>
                                ─ <?= $contrato->area ?></h5>
                        <?php endif; ?>
                    <?php endif; ?>
                </th>
    ...
    <div>
        ...
        <table id="table_faltas" class="table datatable table-striped table-bordered table-condensed" cellspacing="0"
            ...
            <tr class="active">
                ...
                <th class="text-center">Faltas diárias</th>
