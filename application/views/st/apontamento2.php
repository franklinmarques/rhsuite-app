                        ...
                        <div class="modal-body form">
                            <form action="#" id="form_config" class="form-horizontal" autocomplete="off">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input name="dia_fechamento" class="form-control text-right"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input name="qtde_alocados_potenciais" class="form-control text-right"
                                               type="number"
                                               step="1" value="">
                                    </div>
                                    <label class="control-label col-md-2">N&ordm; contrato</label>
                                    <div class="col-md-4">
                                        <input name="contrato" class="form-control" text" value="">
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input name="turnover_reposicao" class="form-control text-right"
                                               type="number" value="">
                                    </div>
                                    <label class="control-label col-md-4">Admissões aumento quadro</label>
                                    <div class="col-md-2">
                                        <input name="turnover_aumento_quadro" class="form-control text-right"
                                               type="number" value="">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input name="turnover_desligamento_empresa" class="form-control text-right"
                                               type="number" value="">
                                    </div>
                                    <label class="control-label col-md-4">Desligamentos colaboradores</label>
                                    <div class="col-md-2">
                                        <input name="turnover_desligamento_colaborador" class="form-control text-right"
                                               type="number" value="">
                                    </div>
                                </div>
                                <div id="ipesp">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">R$</span>
                                            <input name="valor_servico" type="text" style="width: 142px;"
                                                   class="valor form-control text-right"
                                                   aria-describedby="basic-addon1">
                                        </div>
                                    </div>
...
//        busca = $.param(arr_busca);
        ...
        function reload_table(reset = false) {
            ...
            table_colaboradores.ajax.reload(null, reset); //reload datatable ajax
        ...
        function setPdf_atributes() {
            ...
            if ($('[name="area"]').val().length) {
                $('#gestao_consolidada').removeAttr('onclick').css('color', '#333');
            } else {
                $('#gestao_consolidada').attr('onclick', 'return false').css('color', '#888');
            }
