                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('apontamento_colaboradores/getcolaboradores', 'data-html="html-funcionarios" class="form-horizontal" style="margin-top: 15px;" id="busca-funcionarios" autocomplete="off"'); ?>
...
<?php require_once APPPATH . 'views/end_js.php'; ?>
    ...
    <script>
        ...
        function setPdf_atributes() {
            ...
            $('#pdf').prop('href', "<?= site_url('apontamento_colaboradores/pdf/'); ?>" + search);
        }
    </script>
