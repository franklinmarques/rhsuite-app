            ...
            <div class="col-md-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-pencil-square-o"></i> Editar um Treinamento - <?php echo $row['curso'] ?>
                        <span class="tools pull-right">
                            <a class="btn btn-default btn-sm"
                               href="<?php echo site_url('home/cursos'); ?>" style="color: #FFF; margin-top: -5%;">
                                <i class="fa fa-reply"></i> &nbsp;&nbsp; Voltar
                            </a>
                        </span>
                    </header>
                    <div class="panel-body">
                        <?php echo form_open('home/editarcurso_json', 'data-aviso="alert" class="form-horizontal ajax-upload"'); ?>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Nome do Treinamento</label>

                            <div class="col-lg-7 controls">
                                <input type="text" name="curso" value="<?= $row['curso'] ?>" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="categoria" id="categoria" class="form-control"
                                       value="<?= $row['categoria'] ?>"
                                       onkeydown="autoComplete('#categoria', 'getCategorias')"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="area_conhecimento" id="area_conhecimento"
                                       ...
                                       onkeydown="autoComplete('#area_conhecimento', 'getAreaConhecimento')"/>
                            ...
                            <div class="col col-lg-9">
                                <?php if ($this->session->userdata('tipo') == 'empresa') : ?>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="publico"<?= ($row['publico'] == 1 ? ' checked' : ''); ?>  value="1"> Público
                                    </label>
                                <?php endif; ?>
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="gratuito"<?= ($row['gratuito'] == 1 ? ' checked' : ''); ?>  value="1"> Gratuito
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2 controls">
                                <input type="number" value="<?= $row['duracao'] ?>" name="duracao" class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col col-lg-9">
                                <div class="radio">
                                    <label>
                                        <input type="radio" value=""<?= ($row['progressao_linear'] == '1' ? '' : ' checked'); ?> name="progressao_linear"> 
                                        Não-linear (pode avançar páginas e finalizá-las mais tarde)
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="1"<?= ($row['progressao_linear'] == '1' ? ' checked' : ''); ?> name="progressao_linear"> 
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: auto; height: 150px;">
                                        ...
                                        if (!$row['foto_consultor']) {
                                            $foto_consultor = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=Sem+imagem";
                                        }
                                        ?>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: auto; height: 150px;">
                                        ...
                                        if (!$row['foto_treinamento']) {
                                            $foto_treinamento = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=Sem+imagem";
                                        }
                                        ?>
                                ...
                                <div class="col-lg-7 controls">
                                    <select id="usuario" name="usuario" class="form-control">
                                        <?php foreach ($usuarios->result() AS $usuario) : ?>
                                            <option value="<?= $usuario->id; ?>"<?= ($row['usuario'] == $usuario->id ? ' selected=""' : '') ?>>
                                                <?= $usuario->nome; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
...
<script>
                                           ...
                                           $(document).ready(function () {
                                               document.title = 'CORPORATE RH - LMS - Editar Treinamento - <?php echo $row['curso']; ?>';
                                           });
