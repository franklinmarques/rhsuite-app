            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 5px; background-color: #eee;">
                        ...
                        <li class="active">Facilities Ativos</li>
                    </ol>
                    <button class="btn btn-info" onclick="add_ativo()"><i class="glyphicon glyphicon-plus"></i>
                        Adicionar Ativo
                    </button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title">Formulario de ativos</h3>
                        </div>
                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row form-group">
                                        <label class="control-label col-md-3">Nome do ativo</label>
                                        <div class="col-md-9">
                                            <input name="nome" placeholder="Digite o nome do ativo"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input name="data_entrada_operacao" class="form-control data text-center"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input name="anos_duracao" class="form-control" type="text" maxlength="50">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <hr>
...
?>
    ...
    <script>
        $(document).ready(function () {
            document.title = 'CORPORATE RH - LMS - Facilities Ativos';
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('facilities/ativos/ajaxList/' . $idSala) ?>",
                    "type": "POST"
                },
        ...
        function add_ativo() {
            ...
            $('.modal-title').text('Adicionar Ativos'); // Set title to Bootstrap modal title
            $('.combo_nivel1').hide();
        }
        ...
        function edit_ativo(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('facilities/ativos/ajaxEdit') ?>",
                type: "POST",
                dataType: "json",
                data: {id: id},
                success: function (json) {
                    ...
                    $('#modal_form').modal('show');
                    $('.modal-title').text('Editar Ativos'); // Set title to Bootstrap modal title
                },
        ...
        function save() {
            ...
            if (save_method === 'add') {
                url = "<?php echo site_url('facilities/ativos/ajaxAdd') ?>";
            } else {
                url = "<?php echo site_url('facilities/ativos/ajaxUpdate') ?>";
            }
        ...
        function delete_ativo(id) {
            if (confirm('Deseja remover?')) {
                $.ajax({
                    url: "<?php echo site_url('facilities/ativos/ajaxDelete') ?>",
                    type: "POST",
                    dataType: "json",
                    data: {id: id},
                    success: function () {
        ...
        function vistorias(id_item) {
            ...
            if (logado) {
                window.open("<?php echo site_url('facilities/ativosVistorias/gerenciar'); ?>/" + id_item, 'Itens de Vistorias', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=100, LEFT=250, WIDTH=1010, HEIGHT=500');
            } else {
        ...
        function manutencao(id_item) {
            var logado = <?php echo $this->session->userdata('logado') ? 'true' : 'false'; ?>;
            if (logado) {
                window.open("<?php echo site_url('facilities/ativosManutencao/gerenciar'); ?>/" + id_item, 'Itens de Manutenção Periódica', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=100, LEFT=250, WIDTH=1010, HEIGHT=500');
            } else {
                window.open("<?php echo site_url('home/sair'); ?>");
            }
        }
