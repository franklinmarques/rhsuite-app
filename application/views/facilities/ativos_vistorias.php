...
<div class="container-fluid">
    ...
    <button class="btn btn-info" onclick="add_vistoria()"><i class="glyphicon glyphicon-plus"></i>
        Adicionar item de vistorias de ativos
    </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Cadastro de itens de vistorias de ativos</h3>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            'ajax': {
                'url': '<?php echo site_url('facilities/ativosVistorias/ajaxList/' . $this->uri->rsegment(3)) ?>',
                'type': 'POST'
            },
            'columnDefs': [
                {
    ...
    function add_vistoria() {
        ...
        $('.modal-title').text('Cadastrar item de vistoria de ativos');
    ...
    function edit_vistoria(id) {
        ...
        $.ajax({
            url: '<?php echo site_url('facilities/ativosVistorias/ajaxEdit/') ?>',
            data: {
                id: id,
            ...
            success: function (json) {
                ...
                $('.modal-title').text('Editar item de vistoria de ativos');
                $('#modal_form').modal('show');
            }
        });
    }
    ...
    function save() {
        ...
        var url;
        if (save_method === 'add') {
            url = '<?php echo site_url('facilities/ativosVistorias/ajaxAdd') ?>';
        } else {
            url = '<?php echo site_url('facilities/ativosVistorias/ajaxUpdate') ?>';
        }
    ...
    function delete_vistoria(id) {
        if (confirm('Deseja remover?')) {
            $.ajax({
                url: '<?php echo site_url('facilities/ativosVistorias/ajaxDelete') ?>',
                data: {id: id},
