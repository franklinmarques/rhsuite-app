			...
			<div class="col-md-12">
				...
				<div class="form-inline">
					...
					<div class="form-group">
						<label>Mês</label>
						<select class="form-control input-sm" id="mes" onchange="reload_table();">
					...
					<div class="form-group">
						<label>Ano</label>
						<input type="text" class="form-control input-sm text-center ano" id="ano" placeholder="aaaa"
							   onchange="reload_table();" style="width: 64px;">
					</div>
				</div>
