...
<head>
    ...
    <title>CORPORATE RH - LMS - Gerenciar itens de Vistorias de Facilities</title>
...
<div class="container-fluid">
    ...
    <button class="btn btn-info" onclick="add_vistoria()"><i class="glyphicon glyphicon-plus"></i>
        Adicionar item de vistorias de facilities
    </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Cadastro de itens de vistoria de facilities</h3>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            'ajax': {
                'url': '<?php echo site_url('facilities/itensVistorias/ajaxList/' . $this->uri->rsegment(3)) ?>',
                'type': 'POST'
            },
            'columnDefs': [
                {
    ...
    function add_vistoria() {
        ...
        $('.modal-title').text('Cadastrar item de vistoria de facilities');
    ...
    function save() {
        ...
        var url;
        if (save_method === 'add') {
            url = '<?php echo site_url('facilities/itensVistorias/ajaxAdd') ?>';
        } else {
            url = '<?php echo site_url('facilities/itensVistorias/ajaxUpdate') ?>';
        }
