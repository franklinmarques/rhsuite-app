                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title">Formulario de modelo de avaliação</h3>
                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-7">
                                                <select name="tipo" class="form-control">
                                                    <option value="C">Perfil Comportamental</option>
                                                    <option value="N">Potencial - NineBox</option>
                                                </select>
                                            </div>
                                        </div>
                                    <?php endif; ?>
...
?>
    ...
    <script>
        $(document).ready(function () {
            document.title = 'CORPORATE RH - LMS - Modelos de Assessment';
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('assessments_modelos/ajaxList') ?>",
                    "type": "POST"
                },
        ...
        function edit_teste(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('assessments_modelos/ajax_edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function save() {
            ...
            if (save_method === 'add') {
                url = "<?php echo site_url('assessments_modelos/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('assessments_modelos/ajax_update') ?>";
            }
        ...
        function delete_teste(id) {
            if (confirm('Deseja remover?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('assessments_modelos/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data) {
