    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <ol class="breadcrumb" style="margin-bottom: 5px; background-color: #eee;">
                <li class="active">Relatório de Medição Mensal Individual</li>
            </ol>
            <br>
            <div class="row">
                <div class="col-md-12">
            ...
            <table class="table table-condensed table-condensed avaliacao">
                ...
                <tr style='border-bottom: 5px solid #ddd;'>
                    ...
                    <td style="padding: 0px;">
                        <h5><strong>Número de atendimentos no período: </strong><span id="medicao_qtde_atendimentos"></span>
                        </h5>
                    </td>
...
?>
    ...
    <script>
        $(document).ready(function () {
            document.title = 'CORPORATE RH - LMS - Relatório de Medição Mensal Individual';
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "serverSide": true,
                "iDisplayLength": 5000,
                "lengthMenu": [[5, 10, 25, 50, 100, 250, 500, 1000, 2000, 5000], [5, 10, 25, 50, 100, 250, 500, 1000, 2000, 5000]],
                "order": [[3, 'desc']],
                "language": {
...
//            } else 
            ...
            $('#pdf').prop('href', "<?= site_url('papd/relatorios/pdfMedicao_mensal/'); ?>" + search);
        }
