...
<head>
    ...
    <title>CORPORATE RH - LMS - Relatório de Medição Mensal Individual</title>
...
<div class="container-fluid">
    ...
    <table id="table" class="table table-bordered table-condensed">
        <thead>
        <tr class='active'>
            <th class="text-center" width="25%">Paciente</th>
            <th class="text-center" width="32%">Atividades/Procedimentos</th>
            <th class="text-center" width="22%">Profissional</th>
        ...
        <?php foreach ($rows as $row): ?>
            <tr>
                ...
                <td class="text-center"><?= $row->data_hora ?></td>
