    ...
    <head>
        ...
        <style>
            @font-face {
                ...
                src:url('<?= base_url('assets/font/HoneyScriptLight.eot') ?>');
                src:url('<?= base_url('assets/font/HoneyScriptLight.eot?#iefix') ?>') format('embedded-opentype'),
                    url('<?= base_url('assets/font/HoneyScriptLight.woff') ?>') format('woff'),
                    url('<?= base_url('assets/font/HoneyScriptLight.ttf') ?>') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
            /* reset de margens */
                ...
                <div class="certificado">
                    ...
                    <div class='text'>
                        <p style="text-align: justify;">
                            ...
                            no período de <?php echo $data_inicial . $data_final; ?>, com carga horária de <?php echo $duracao; ?> hora(s).
                        </p>
                        <br/>
                    </div>
                    ...
                    <div>
                        <?php if ($assinatura): ?>
                            <div class='assinatura'><img src='<?= base_url('imagens/usuarios/' . $assinatura) ?>'></div>
                        <?php else: ?>
                            <hr style='color:#FFF; width:100%; padding: 0 !important; margin: 0 !important;'/>
