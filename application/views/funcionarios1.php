                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('home/getfuncionarios1', 'data-html="html-funcionarios" class="form-horizontal" style="margin-top: 15px;" id="busca-funcionarios" autocomplete="off"'); ?>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-sm-offset-2 controls">
                                        ...
                                        <input type="text" name="busca"
                                               placeholder="Buscar nome, e-mail, matrícula ou município..."
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-lg-2">
                                        <label class="control-label">Filtrar tipo vínculo</label>
                                        <select name="tipo_vinculo" class="form-control input-sm filtro">
                                            <option value="">Todos</option>
                                    ...
                                    <div class="col-md-2">
                                        <label class="control-label">Filtrar por matrícula</label>
                                        <?php echo form_dropdown('matricula', $matricula, '', 'class="form-control input-sm filtro"'); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Filtrar por nível acesso</label>
                                        <?php echo form_dropdown('nivel_acesso', $nivel_acesso, '', 'class="form-control input-sm filtro"'); ?>
                                    </div>
                                </div>
                            </div>
