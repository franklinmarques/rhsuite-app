                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-search"></i> Gerenciar documentos - Organização
                        </header>
                        <div class="panel-body">
                            <?php echo form_open('documento/getDocumentoOrganizacao', 'data-html="html-documento" class="form-horizontal" style="margin-top: 15px;" id="busca-funcionarios"'); ?>
