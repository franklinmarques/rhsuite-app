            ...
            <div class="col-md-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <a class="btn btn-success btn-sm" style="float:right;border-radius: 20px !important; margin-top: -0.5%;" href="<?php echo site_url('home/novocursoempresa/' . $this->uri->rsegment(3)); ?>"><i class="fa fa-plus"></i> Adicionar</a>
                    </header>
                    <div class="panel-body">
                        <?php echo form_open('home/getcursosempresa/' . $row->id, 'data-html="html-cursos-empresa" class="form-horizontal" style="margin-top: 15px;" id="busca-cursos-empresa"'); ?>
