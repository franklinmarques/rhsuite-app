										...
										<div class="form-group">
											...
											<div class="col-xs-4 controls">
												<select name="tipo_vinculo" class="form-control"
													...
													<option value="6">LTDA</option>
												</select>
											</div>
											<div class="col-xs-5 controls">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="possui_apontamento_horas" value="1">
										...
										<div class="form-group">
											...
											<div class="col-xs-6 controls">
												<select name="nivel_acesso" class="form-control">
													...
													<option value="20">Colaborador ME</option>
													<option value="14">Colaborador PJ</option>
													<option value="21">Colaborador LTDA</option>
