						...
						<div class="modal-body form">
							...
							<form action="#" id="form" enctype="multipart/form-data" class="form-horizontal">
								<div class="form-body">
									...
									<div class="row form-group">
										<label class="control-label col-md-2">Tipo de proposta</label>
										<div class="col-md-3">
											<select name="tipo" class="form-control">
												<option value="P">Modelo padrão</option>
												<option value="C">Customizada</option>
											</select>
											<span class="help-block"></span>
										</div>
									...
									<div class="row form-group">
										<label class="control-label col-md-2">Custo administrativo</label>
										<div class="col-md-3">
											<div class="input-group">
												<span class="input-group-addon" id="basic-addon1">R$</span>
