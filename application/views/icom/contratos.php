									...
									<form action="#" id="form" enctype="multipart/form-data"
										...
										<div class="form-body">
											...
											<div class="row form-group">
												...
												<div class="col-md-3">
													<?php echo form_dropdown('tipo_contrato', $tipoContrato, '', 'class="form-control"'); ?>
													<span class="help-block"></span>
												</div>
											...
											<div class="row form-group">
												<label class="control-label col-md-2">Condições de pagamento</label>
												<div class="col-md-9">
													<textarea name="condicoes_pagamento" class="form-control" rows="5"
