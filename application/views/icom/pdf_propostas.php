...
<head>
    ...
    <title>CORPORATE RH - LMS - Relatório de Propostas</title>
...
<div class="container-fluid">
    ...
    <table id="propostas" class="table table-condensed table-condensed">
        <thead>
        <tr style='border-top: 5px solid #ddd;'>
            <th colspan="3" style="padding-bottom: 12px;">
                <h3 class="text-center" style="font-weight: bold;">RELATÓRIO DE PROPOSTAS</h3>
            </th>
        </tr>
        </thead>
        <tbody>
