            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <?php if (!in_array($this->session->userdata('tipo'), array('administrador', 'funcionario'))) { ?>
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li style="border-bottom: solid 1px rgba(255,255,255,0.2);"><a href="<?php echo site_url('home/paginaAvaliacao'); ?>">Avaliações Por Competências</a></li>
                            <li><a href="<?php echo site_url('avaliacaoexp_modelos'); ?>">Modelos de Avaliações</a></li>							
                            <li><a href="<?php echo site_url('home/funcionarios'); ?>">Avaliações Período Experiência</a></li>
                            <li style="border-bottom: solid 1px rgba(255,255,255,0.2);"><a href="<?php echo site_url('manutencao'); ?>">Avaliações Periódicas Desempenho</a></li>
                ...
                if (in_array($this->session->userdata('tipo'), array('funcionario'))) {
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="<?php echo site_url('avaliacaoexp_avaliador/periodo'); ?>">Avaliação Período Experiência</a></li>
                        </ul>
                        <ul class="sub">
                            <li><a href="<?php echo site_url('avaliacaoexp_avaliador/desempenho'); ?>">Avaliações Desempenho Periódicas</a></li>
                        </ul>
                        <ul class="sub">
                            <li><a href="<?php echo site_url('home/paginaAvaliador'); ?>">Avaliação Por Competências</a></li>
                        </ul>
                    </li>
                    <?php
                }
