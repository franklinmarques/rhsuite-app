    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <button class="btn btn-success" onclick="add_posto()"><i class="glyphicon glyphicon-plus"></i> Adicionar posto</button>
                            ...
                            <form action="#" id="busca" class="form-horizontal" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input name="busca_ano" placeholder="aaaa" class="form-control input-sm" maxlength="4" type="number">
                                    </div>
                                    <div class="col-md-1">
                                        <label>&nbsp;</label><br>
                                        <div class="btn-group" role="group" aria-label="...">
                                            <button type="button" id="limpa_filtro" class="btn btn-sm btn-default">Limpar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input name="ano" id="ano" placeholder="aaaa" class="form-control text-right" maxlength="4" type="number">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" id="copiar_posto" class="btn btn-info" onclick="get_posto_anterior();">Copiar valores do posto anterior</button>
                                    </div>
                                </div>
                                <hr>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input name="valor_posto" type="number" step="0.01" class="valor form-control text-right" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" id="calcular_valor" class="btn btn-info">Calcular valores</button>
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6 form-inline">
                                        <input name="total_dias_mensais" type="number" step="1" style="width: 100px;" class="valor form-control text-right">
                                        &emsp;Valor
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">R$</span>
                                            <input name="valor_dia" type="number" step="0.01" style="width: 120px;" class="form-control text-right" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6 form-inline">
                                        <input name="total_horas_diarias" type="number" step="1" style="width: 100px;" class="valor form-control text-right">
                                        &emsp;Valor
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">R$</span>
                                            <input name="valor_hora" type="number" step="0.01" style="width: 120px;" class="form-control text-right" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('apontamento_postos/ajax_list/') ?>",
                "type": "POST",
                data: function (d) {
    ...
    function atualizarFiltro() {
        $.ajax({
            url: "<?php echo site_url('apontamento_postos/atualizar_filtro/') ?>",
            type: "POST",
            dataType: "JSON",
    ...
    function get_posto_anterior() {
        $.ajax({
            ...
            success: function (data)
            {
                $('[name="matricula"]').val(data.matricula);
                $('[name="login"]').val(data.login);
                $('[name="horario_entrada"]').val(data.horario_entrada);
                $('[name="horario_saida"]').val(data.horario_saida);
    ...
    function edit_posto(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('apontamento_postos/ajax_edit/') ?>",
            type: "POST",
            dataType: "JSON",
            data: {id: id},
            success: function (data)
            {
                ...
                $('[name="mes"]').val(data.mes);
                $('[name="ano"]').val(data.ano);
                $('[name="matricula"]').val(data.matricula);
                $('[name="login"]').val(data.login);
                $('[name="horario_entrada"]').val(data.horario_entrada);
                $('[name="horario_saida"]').val(data.horario_saida);
    ...
    function save()
    {
        ...
        if (save_method === 'add') {
            url = "<?php echo site_url('apontamento_postos/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('apontamento_postos/ajax_update') ?>";
        }
    ...
    function delete_posto(id)
    {
        if (confirm('Deseja remover?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('apontamento_postos/ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function (data)
