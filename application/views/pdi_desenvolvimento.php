            ...
            <div class="col-md-12">
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-search"></i> Itens de PDI <?= $pdi ?> do funcionário - <?= $nome_usuario . ' - ' . $funcao_usuario ?>
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open('pdi_desenvolvimento/ajax_list/' . $pdi, 'data-html="html-funcionarios" class="form-horizontal" style="margin-top: 15px;" id="busca-funcionarios"'); ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form">
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <input type="hidden" value="<?= $pdi; ?>" name="pdi"/> 
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-2">Competência/item a desenvolver</label>
                                    <div class="col-md-7">
                                        <input type="text" name="competencia" placeholder="Competencia" value="" class="form-control"/>
                                    </div>
...
<script>
    $(document).ready(function () {
        document.title = 'CORPORATE RH - LMS - Itens de PDI <?= $pdi ?> do funcionário - <?= $nome_usuario . ' - ' . $funcao_usuario ?>';
    });
</script>
