        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-info" onclick="ver_modelos()"><i class="glyphicon glyphicon-list-alt"></i>
                    ...
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th>Teste Seletivo realizado</th>
                            <th>Início</th>
                            <th>Término</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <input type="hidden" value="O" name="tipo_teste"/>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('recrutamentoPresencial_processos/ajax_list/' . $id_usuario . '/' . ($nome_cargo ? $id_candidato : '')) . '/1' ?>",
                    "type": "POST"
                },
                rowsGroup: [0, 1],
...
//                },
        ...
        function edit_teste(id) {
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    $('[name="hora_inicio"]').val(json.hora_inicio);
                    $('[name="hora_termino"]').val(json.hora_termino);
                    $('[name="minutos_duracao"]').val(json.minutos_duracao);
        ...
        function salvar_cargo() {
            ...
            // ajax adding data to database
            $.ajax({
                url: "<?php echo site_url('recrutamentoPresencial_processos/ajax_addCargo') ?>",
                type: "POST",
