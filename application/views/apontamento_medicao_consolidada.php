...
<head>
	...
	<title>CORPORATE RH - LMS - Relatório de Medição Consolidada</title>
...
<div class="container-fluid">
		...
		<table id="table" class="table table-condensed">
			...
			<tr style='border-top: 5px solid #ddd;'>
				<th colspan="<?= $is_pdf == false ? '3' : '2' ?>" style="padding-bottom: 8px; text-align: center;">
					<?php if ($is_pdf == false): ?>
						<h3 class="text-center" style="font-weight: bold;">RELATÓRIO DE MEDIÇÃO CONSOLIDADA
							- <?= mb_strtoupper($mes_ano) ?></h3>
					<?php else: ?>
						<h4 class="text-center" style="font-weight: bold;">RELATÓRIO DE MEDIÇÃO CONSOLIDADA
	...
	<div>
		<table id="medicao_consolidada" class="table table-bordered table-condensed">
			<thead>
			<tr class="active">
				<th rowspan="2" style="vertical-align: middle;">Colaborador(a)</th>
				<th rowspan="2" class="text-center" style="vertical-align: middle;">Qtde.</th>
