                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group alternativa">
                                        ...
                                        <label class="control-label col-md-1">Escala</label>
                                        <div class="col-md-3">
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[0]" value="1" class="peso1"> 1
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[0]" value="2" class="peso1"> 2
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[0]" value="3" class="peso1"> 3
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[0]" value="4" class="peso1"> 4
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group alternativa">
                                        ...
                                        <div class="col-md-3">
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[1]" value="1" class="peso2"> 1
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[1]" value="2" class="peso2"> 2
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[1]" value="3" class="peso2"> 3
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[1]" value="4" class="peso2"> 4
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group alternativa">
                                        ...
                                        <div class="col-md-3">
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[2]" value="1" class="peso3"> 1
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[2]" value="2" class="peso3"> 2
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[2]" value="3" class="peso3"> 3
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[2]" value="4" class="peso3"> 4
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group alternativa">
                                        ...
                                        <div class="col-md-3">
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[3]" value="1" class="peso4"> 1
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[3]" value="2" class="peso4"> 2
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[3]" value="3" class="peso4"> 3
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="peso[3]" value="4" class="peso4"> 4
                                            </label>
                                        </div>
                                    </div>
                                </div>
...
?>
    ...
    <script>
        $(document).ready(function () {
            document.title = 'CORPORATE RH - LMS - Questões para Teste de Personalidade - Orientações de Vida';
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('pesquisa_orientacoes/ajax_list/' . $id_modelo) ?>",
                    "type": "POST"
                },
        ...
        $('input[type="radio"]').on('change', function () {
            ...
            $('input[type="radio"][value="' + valor + '"]').prop('checked', false);
        ...
        function edit_pergunta(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('pesquisa_orientacoes/ajax_edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function (data) {
                    ...
                    $(data.alternativas).each(function (index, field) {
                        ...
                        $('.alternativa:eq(' + index + ') input[name="peso[' + index + ']"][value="' + field.peso + '"]').prop('checked', true);
                    });
        ...
        function save() {
            ...
            if (save_method === 'add') {
                url = "<?php echo site_url('pesquisa_orientacoes/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('pesquisa_orientacoes/ajax_update') ?>";
            }
        ...
        function delete_pergunta(id) {
            if (confirm('Deseja remover?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('pesquisa_orientacoes/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data) {
