        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb" style="margin-bottom: 5px;">
                    <li>
                        <a href="<?= site_url("competencias/cargos/") ?>">Cargo-função: </a><?= $options_cargos['nome_cargo'] ?>
                    </li>
                    <li>
                        <?php if ($options_cargos['tipo'] === 'T'): ?>
                            <a href="<?= site_url("competencias/tipo/tecnica/" . $options_cargos['id_cargo']) ?>">Competência
                                técnica: </a>
                        <?php elseif ($options_cargos['tipo'] === 'C'): ?>
                            <a href="<?= site_url("competencias/tipo/comportamental/" . $options_cargos['id_cargo']) ?>">Competência
                                comportamental: </a>
                        <?php else: ?>
                ...
                <div class="row form-inline">
                    <div class="col-sm-6 col-md-5">
                        <button class="btn btn-success" onclick="add_dimensao()"><i
                                    class="glyphicon glyphicon-plus"></i> Adicionar comportamento/dimensão
                        </button>
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <input type="hidden" name="cargo_competencia" id="cargo_competencia"
                                           value="<?= $options_cargos['cargo_competencia'] ?>">
                                ...
                                <div class="form-group input_competencia">
                                    <div class="col-md-7">
                                        <div class="row">
                                            <label class="control-label col-md-5">Comportamento observável ou dimensão
                                                da competência</label>
                                            <div class="col-md-7">
                                                <textarea class="form-control" rows="4" id="nome" name="nome"
                                                          placeholder="Digite o comportamento observável"
                                                          style="max-width: 100%;"></textarea>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="control-label col-md-5">Nível mínimo de habilidade e
                                                conhecimento demandado pelo cargo/função</label>
                                            <div class="col-md-7">
                                                <select class="form-control" id="nivel" name="nivel">
                                                    <option value="0" selected="selected">0 - Nenhum conhecimento
                                                    </option>
                                        ...
                                        <div class="row form-group">
                                            <label class="control-label col-md-5">Nível mínimo de atitude exigido pelo
                                                cargo/função</label>
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn btn-default"
                                                                ...
                                                                &nbsp;&nbsp;80% = Muitas vezes; <br>
                                                                100% = Todas as vezes." data-trigger="focus"
                                                                data-html="true">
                                                ...
                                                <div style="overflow-x: hidden;overflow-y: scroll; height: 210px;">
                                                    ...
                                                    <ul id="sugestao" class="list-group">
                                                        <?php foreach ($sugestoes as $k => $sugestao): ?>
                                                            <li id="<?= $sugestao->id ?>"
                                                                class="sugestao_competencia list-group-item"><?= $sugestao->nome ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                    <span class="help-block"></span>
                                                </div>
    ...
    function edit_dimensao(id) {
        ...
        $.ajax({
            ...
            'success': function (json) {
                ...
                $('[name="id_dimensao"]').val(json.id_dimensao);
