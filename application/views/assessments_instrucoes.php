        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb" style="margin-bottom: 5px; background-color: #eee;">
                    <li><a href="<?= site_url('assessments_modelos') ?>">Modelos de Teste de Seleção</a></li>
                    <li class="active">Instruções - <?= $nome ?></li>
                </ol>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <button class="btn btn-default" onclick="javascript:history.back()">Cancelar</button>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div id="alert"></div>
                    <div class="col-xs-12">
                        <?php echo form_open('assessments_modelos/salvar_instrucoes', 'data-aviso="alert" class="form-horizontal ajax-upload" id="form"'); ?>
                        <input type="hidden" name="id" value="<?= $modelo ?>"/>
                        <div id="box-ckeditor">
                            <label>Digite ou copie no espaço de edição abaixo o texto que servirá de referência para este teste</label>
                            <textarea name="instrucoes" id="instrucoes" class="form-control" rows="1"><?= $instrucoes; ?></textarea>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <audio id="audio" controls style="width: 100%;" src="<?= (isset($row->audio) ? base_url("arquivos/media/") : ''); ?>"></audio>
                        <hr/>
                        <div id="time">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video id="previewVideo" controls style="border: 1px solid #000; height: 240px; width: 100%;">
                            <source id="previewAudio" src="<?= (isset($row->video) ? base_url("arquivos/media/$row->video") : ''); ?>">
                        </video>
                        <hr/>
...
<script>
    $(document).ready(function () {
        document.title = 'CORPORATE RH - LMS - Instruções para teste de seleção - <?= $nome ?>';
    });
</script>
