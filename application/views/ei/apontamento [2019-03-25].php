...
<?php require_once APPPATH . 'views/end_js.php'; ?>
    ...
    <script>
        ...
        function teste() {
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento/teste/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function edit_recesso(id_alocado) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento/ajaxEditRecesso/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function edit_totalizacao(id_alocado, mes, periodo, substituto) {
            ...
            $.ajax({
                ...
                'success': function (json) {
                    ...
                    $('#form_totalizacao [name="id_alocado"]').val(json.id_alocado);
                    $('#form_totalizacao [name="periodo"]').val(json.periodo);
        ...
        function save_recesso() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento/ajaxSaveRecesso') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function recuperar_totalizacao() {
            ...
            $.ajax({
                ...
                'dataType': 'json',
                'data': {
                    'id_alocado': $('#form_totalizacao [name="id_alocado"]').val(),
                    'mes': $('#form_totalizacao [name="mes"]').val(),
                    'periodo': $('#form_totalizacao [name="periodo"]').val(),
