<?php require_once APPPATH . 'views/header.php'; ?>
    ...
    <section id="main-content">
        <section class="wrapper">
                                ...
                                <?php if ($modo_privilegiado): ?>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li><a href="<?= site_url('ei/relatorios/medicao'); ?>" target="_blank"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-sm-3 text-center">
                                            <button type="button" class="btn btn-sm btn-success"
                                                ...
                                                Recalcular qtde. dias (data término real)
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form_totalizacao" class="form-horizontal">
                                ...
                                <input type="hidden" value="" name="mes"/>
                                <input type="hidden" value="" name="substituto"/>
                                <input type="hidden" value="" id="periodo_totalizacao"/>
                                <div class="row form-group">
            ...
            <!-- Bootstrap modal -->
            <div class="modal fade" id="modal_recesso" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form_recesso" class="form-horizontal">
                                <input type="hidden" value="" name="id_alocado"/>
                                <div class="row form-group">
                                    <label class="control-label col-md-4">Data término semestre</label>
                                    <div class="col-md-3">
                                        <input name="data_recesso" type="text" class="form-control text-center data">
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="btnSaveRecesso" onclick="save_recesso()" class="btn btn-success">
                                Salvar
                            </button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        </div>
    ...
    <script>
        ...
        $('.desconto').mask('00:00', {
            'onChange': function (desconto, e, field, options) {
                ...
                var mask = '00:00';
                if (status.indexOf(['FA', 'PV', 'AT', 'SA', 'AN']) >= 0) {
                    var mask = '-00:00';
                }
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                'ajax': {
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxListEventos') ?>',
                    'type': 'POST',
                    'timeout': 90000,
                    'data': function (d) {
                        d.busca = busca;
            ...
            table_faturamento = $('#table_faturamento').DataTable({
                ...
                'ajax': {
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxListFaturamento') ?>',
                    'type': 'POST',
                    'timeout': 90000,
                    'data': function (d) {
                        d.busca = busca;
                    ...
                    },
                    {
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            if (rowData[col] !== null || rowData[26] !== null) {
                                ...
                                $(td).css('cursor', 'pointer').on('click', function () {
                                    edit_ajuste_mensal(rowData[25], table_faturamento.context[0].json.mes, 0);
                                });
                            }
                    ...
                    },
                    {
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            if (rowData[col] !== null || rowData[26] !== null) {
                                ...
                                $(td).css('cursor', 'pointer').on('click', function () {
                                    edit_ajuste_mensal(rowData[25], table_faturamento.context[0].json.mes, 1);
                                });
                            }
                            $(td).html(rowData[col] !== null ? rowData[col] : '00:00');
                        },
                    ...
                    },
                    {
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            if (rowData[col] !== null || rowData[26] !== null) {
                                ...
                                $(td).css('cursor', 'pointer').on('click', function () {
                                    edit_ajuste_mensal(rowData[25], table_faturamento.context[0].json.mes, 2);
                                });
                            }
                            $(td).html(rowData[col] !== null ? rowData[col] : '00:00');
                        },
            ...
            table_controle_materiais = $('#table_controle_materiais').DataTable({
                ...
                'ajax': {
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxListControleMateriais') ?>',
                    'type': 'POST',
                    'timeout': 90000,
                    'data': function (d) {
                        d.busca = busca;
            ...
            table_visitas = $('#table_visitas').DataTable({
                ...
                'ajax': {
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxListVisitas') ?>',
                    'type': 'POST',
                    'timeout': 90000,
                    'data': function (d) {
                        d.busca = busca;
        ...
        function atualizarFiltro() {
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/atualizarFiltro/') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        $('#municipio_sub1').on('change', function () {
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/atualizarSubstituto/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function preparar_os() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/prepararOS/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': busca,
                'success': function (json) {
                    ...
                    $('#form_os [name="semestre"]').val($('#busca [name="mes"]').val() > 6 ? 2 : 1);
        ...
        function filtrar_os_escolas() {
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/filtrarOSEscolas/') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function iniciar_semestre() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/iniciarSemestre/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#form_os').serialize(),
                'success': function (json) {
        ...
        function preparar_os_individual() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/prepararOSIndividual/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': busca,
                'success': function (json) {
        ...
        function limpar_semestre() {
            ...
            if (confirm('Deseja limpar o semestre do mês corrente?')) {
                ...
                $.ajax({
                    'url': '<?= site_url('ei/apontamento_new/limparSemestre/') ?>',
                    'type': 'POST',
                    'dataType': 'json',
        ...
        function edit_cuidador(id) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditCuidador/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'id_alocado': id
                ...
                'success': function (json) {
                    ...
                    $('#form_cuidador [name="id_profissional"]').html($(json.id_profissional).html());
        ...
        function filtrar_cuidador() {
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxFiltrarCuidador/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function edit_evento(id, date, periodo) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEdit/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'id_alocado': id,
                ...
                'success': function (json) {
                    ...
                    $('#form [name="status"][value="' + json.status + '"]').prop('checked', true);
        ...
        function edit_faturamento(id_faturamento, mes, substituto) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditFaturamento/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function edit_recesso(id_alocado) {
            $('#form_recesso')[0].reset();
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditRecesso/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                ...
                'success': function (json) {
                    if (json.erro) {
                        ...
                        $('#form_recesso [name="id_alocado"]').val(id_alocado);
                        $('#form_recesso [name="data_recesso"]').val(json.data_recesso);

                        $('#modal_recesso').modal('show');
                    }
                },
                'error': function (jqXHR, textStatus, errorThrown) {
                    alert('Error get data from ajax');
        ...
        function edit_substituto(id_horario, mes) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditSubstituto/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function edit_totalizacao(id_alocado, mes, periodo, substituto) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditTotalizacao/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'id_alocado': id_alocado,
                ...
                'success': function (json) {
                    ...
                    $('#periodo_totalizacao').val(periodo);
        ...
        function planilha_faturamento_consolidado() {
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/faturamentoConsolidado/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#busca').serialize(),
                'success': function (json) {
        ...
        function edit_ajuste_mensal(id_alocado, mes, substituto) {
            $('#form_ajuste_mensal')[0].reset();
            $('#form_ajuste_mensal [name="id"], #form_ajuste_mensal [name="mes"]').val('');
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditAjusteMensal/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'id_alocado': id_alocado,
        ...
        function edit_pagamento_prestador(id_horario, mes, substituto) {
            ...
            $.ajax({
                'url': '<?= site_url('ei/apontamento_new/ajaxEditPagamentoPrestador/') ?>',
                'type': 'POST',
                'dataType': 'JSON',
                'data': {
                    'id_horario': id_horario,
                ...
                'success': function (json) {
                    ...
                    $('#form_pagamento_prestador [name="mes"]').val(json.mes);
                    ...
                    $('#form_pagamento_prestador [name="data_inicio_contrato"]').val(json.data_inicio_contrato);
                    $('#form_pagamento_prestador [name="data_termino_contrato"]').val(json.data_termino_contrato);
        ...
        function edit_controle_materiais(id_matriculado, col) {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxEditControleMateriais/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function gerenciar_visitas(id_mapa_visitacao, id_mes) {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxVisitas/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'async': false,
                'data': {
                    'id_mapa_visitacao': id_mapa_visitacao,
                    'id_mes': id_mes
                },
                'success': function (json) {
                    $('#form_visitas [name="id"]').html($(json.id).html());
                    $('#id_mapa_visitacao').val(id_mapa_visitacao);
                    $('#visita_mes').val(id_mes);
                    $('#form_visitas [name="id_mapa_visitacao"]').val(json.id_mapa_visitacao);
                    ...
                    if (json.id_selecionado) {
                        ...
                        $('#btnLimparVisitas').prop('disabled', false);
                    } else {
                        save_method = 'add';
                        $('#modal_visitas .modal-title').text('Adicionar relatório de visita');
                        $('#btnLimparVisitas').prop('disabled', true);
                    }
        ...
        function edit_visita(id) {
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxEditVisita/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'async': false,
                'data': {
                    ...
                    'id_mapa_visitacao': $('#id_mapa_visitacao').val()
                },
                'success': function (json) {
        ...
        function atualizarFiltrosVisitas() {
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/atualizarFiltrosVisitas/') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function salvar_os_individual() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/adicionarOSIndividual') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function save() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSave') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#form').serialize(),
                'success': function (json) {
        ...
        function save_eventos() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveEventos') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'busca': busca,
        ...
        function save_cuidador() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveCuidador') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function delete_eventos() {
            if (confirm('Deseja limpar os eventos desta data?')) {
                ...
                $('#btnSaveEventos, #btnDeleteEventos').attr('disabled', true);
                $.ajax({
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxDeleteEventos') ?>',
                    'type': 'POST',
                    'dataType': 'json',
                    'data': {
                        'busca': busca,
        ...
        function save_faturamento() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveFaturamento') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function save_recesso() {
            $('#btnSaveRecesso').text('Salvando...').attr('disabled', true);
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveRecesso') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#form_recesso').serialize(),
                'success': function (json) {
                    $('#btnSaveRecesso').text('Salvar').attr('disabled', false);
                    if (json.erro) {
                        alert(json.erro);
                    } else {
                        $('#modal_recesso').modal('hide');
        ...
        function save_faturamento_consolidado() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveFaturamentoConsolidado') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function recuperar_faturamento_consolidado() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/recuperarFaturamentoConsolidado') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#busca').serialize(),
                'success': function (json) {
                    $('#planilha_faturamento_consolidado').html(json.planilha_pagamento_prestador);
        ...
        function save_substituto() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveSubstituto') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function save_totalizacao() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveTotalizacao') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function recuperar_totalizacao() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxRecuperarTotalizacao') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'id': $('#form_totalizacao [name="id"]').val(),
                    'mes': $('#form_totalizacao [name="mes"]').val(),
                    'periodo': $('#periodo_totalizacao').val(),
        ...
        function save_ajuste_mensal() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveAjusteMensal') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function save_pagamento_prestador() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSavePagamentoPrestador') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function recuperar_pagamento_prestador() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxRecuperarPagamentoPrestador') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
        ...
        function save_controle_materiais() {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxSaveControleMateriais') ?>',
                'type': 'POST',
        ...
        function save_visita() {
            ...
            if (save_method === 'add') {
                url = '<?php echo site_url('ei/apontamento_new/ajaxAddVisita') ?>';
            } else {
                url = '<?php echo site_url('ei/apontamento_new/ajaxUpdateVisita') ?>';
            }
        ...
        function limpar_visita() {
            if (confirm('Deseja limpar o evento?')) {
                $.ajax({
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxDeleteVisita') ?>/',
                    'type': 'POST',
                    'dataType': 'json',
                    'data': {
                        'id': $('#form_visitas [name="id"]').val()
        ...
        function delete_controle_materiais() {
            if (confirm('Deseja remover?')) {
                $.ajax({
                    'url': '<?php echo site_url('ei/apontamento_new/ajaxDeleteControleMateriais') ?>/',
                    'type': 'POST',
                    'dataType': 'json',
                    'data': {
        ...
        function apagar() {
            ...
            $('#btnSave, #btnApagar').attr('disabled', true);
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/ajaxDelete') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': {
                    'id': $('#form [name="id"]').val()
        ...
        function fechar_mes(id_alocado = '', periodo = '') {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/fecharMes') ?>',
                'type': 'POST',
                'dataType': 'json',
        ...
        function fechar_semestre(id_alocado = '', periodo = '') {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/fecharSemestre') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#busca').serialize() + '&id_alocado=' + id_alocado + '&periodo=' + periodo,
                'success': function (data) {
        ...
        function totalizar_mes(id_alocado = '', periodo = '') {
            ...
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/totalizarMes') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#busca').serialize() + '&id_alocado=' + id_alocado + '&periodo=' + periodo,
                'success': function (data) {
        ...
        function recalcular_recesso() {
            ...
            $('#btnRecalcularRecesso').attr('disabled', true).text('Recalculando qtde. dias (data término real)...');
            $.ajax({
                'url': '<?php echo site_url('ei/apontamento_new/recalcularRecesso') ?>',
                'type': 'POST',
                'dataType': 'json',
                'data': $('#busca').serialize(),
                'success': function (json) {
                    ...
                    $('#btnRecalcularRecesso').attr('disabled', false).text('Recalcular qtde. dias (data término real)');
                },
                'error': function (jqXHR, textStatus, errorThrown) {
                    alert('Error get data from ajax');
                    $('#btnRecalcularRecesso').attr('disabled', false).text('Recalcular qtde. dias (data término real)');
