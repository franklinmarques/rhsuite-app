			...
			<div class="col-md-12">
				...
				<table id="table" class="table table-striped table-bordered table-condensed" cellspacing="0"
					...
					<tr>
						...
						<th colspan="8" class="text-center">Valor período</th>
					</tr>
					<tr>
						<th>Nome</th>
						<th>Ações</th>
					...
					<div class="modal-body form">
						<form action="#" id="form" class="form-horizontal">
							...
							<div class="form-body">
								...
								<div class="row form-group">
									<label class="control-label col-md-2">Município/Estado<span
											class="text-danger"> *</span></label>
									<div class="col-md-9">
					...
					<div class="modal-body form">
						<form action="#" id="form_valores" class="form-horizontal">
							...
							<div class="form-body">
								...
								<div class="row form-group">
									<label class="control-label col-md-4">Qtde. horas</label>
									<div class="col-sm-3">
										<input name="qtde_horas" type="text" value=""
											   class="form-control text-center valor2">
									</div>
								</div>
								<div class="row form-group">
	...
	function edit_valor_faturamento(id) {
		...
		$.ajax({
			...
			'success': function (json) {
				...
				$('#modal_valores [name="id_funcao"]').html($(json.funcoes).html());
				$('#modal_valores [name="qtde_horas"]').val(json.qtde_horas);
