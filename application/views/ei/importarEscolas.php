            ...
            <div class="col-md-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-plus"></i> Importar escolas
                        <button class="btn btn-default btn-sm" style="float: right; margin-top: -0.6%;" onclick="javascript:history.back()"><i
                                class="glyphicon glyphicon-circle-arrow-left"></i> Voltar
                        </button>
                    </header>
                    <div class="panel-body">
                        <?php echo form_open_multipart('ei/escolas/importarCsv', 'data-aviso="alert" class="form-horizontal ajax-upload"'); ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p> 1. Abra o aplicativo do excel e delete as planilhas (abas) extras, deixando somente uma
                            planilha ativa.</p>
                        <p> 2. Identifique a primeira linha com as seguintes palavras: escola, endereço, número, complemento, bairro, município, tel., tel. contato, e-mail, CEP, diretoria e período.</p>
                            ...
                            <div class='table-responsive'>
                                <table class="table table-bordered table-striped table-condensed"
                                    ...
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;">Endereço</th>
                                        ...
                                        <th style="vertical-align: middle;">Município</th>
                                        <th style="vertical-align: middle;" nowrap>Tel. <span style="color: red;">**</span></th>
                                        <th style="vertical-align: middle;" nowrap>Tel. contato <span style="color: red;">**</span><br>(opcional)</th>
                                        <th style="vertical-align: middle;">E-mail<br>(opcional)</th>
                                        <th style="vertical-align: middle;">CEP</th>
                                        <th style="vertical-align: middle;">Diretoria</th>
                                        <th style="vertical-align: middle;">Supervisor(a)<br>(opcional)</th>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td>escola1@provedor.com.br</td>
                                        <td></td>
                                        <td>nomediretoria</td>
                                        <td>nomesupervisor(a)</td>
