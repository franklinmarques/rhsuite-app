                    ...
                    <td nowrap>
                        <?php if ($modo == 'normal'): ?>
                            <a id="pdf" class="btn btn-sm btn-danger"
                               href="<?= site_url('ei/relatorios/pdfResultados/q?' . $query_string); ?>"
                        ...
                        <?php elseif ($modo == 'diretorias'): ?>
                            <a id="pdf" class="btn btn-sm btn-danger"
                               href="<?= site_url('ei/relatorios/pdfResultadosDiretorias/q?' . $query_string); ?>"
                               title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
                        <?php else: ?>
                            <a id="pdf" class="btn btn-sm btn-danger"
                               href="<?= site_url('ei/relatorios/pdfResultadosConsolidados/q?' . $query_string); ?>"
                               title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
                        <?php endif; ?>
                    </td>
                <?php endif; ?>
