				...
				<?php foreach ($funcoes as $funcao): ?>
					<tr>
						...
						<?php if ($is_pdf): ?>
							...
							<td class="text-center"><?= secToTime($funcao->total_segundos_mes ?: $funcao->total_secs_realizados, false); ?></td>
						<?php else: ?>
							...
							<th><input name="total_horas_realizadas[]"
									   value="<?= secToTime($funcao->total_segundos_mes ?: $funcao->total_secs_realizados, false); ?>"
					...
					<tr>
						...
						<?php else: ?>
							...
							<th><input name="resultado_percentual[]"
									   value="<?= number_format($funcao->resultado_percentual, 1, ',', ''); ?>"
									   type="text"
