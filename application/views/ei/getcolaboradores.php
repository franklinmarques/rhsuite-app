        ...
        <tr>
            ...
            <td nowrap>
                <a class="btn btn-primary btn-xs"
                   href="<?php echo site_url('ei/colaboradores/editar_perfil/' . $row->id); ?>">
                ...
                <a class="btn btn-magenta btn-xs" href="<?php echo site_url('pdi/gerenciar/' . $row->id); ?>"
                   style="background-color: #A0511D; color: #FFF;">
                    <i class="fa fa-briefcase"></i> PDIs
                </a>
                <button type="button" class="btn btn-xs btn-info"
                        onclick="gerenciar_contratos('<?= $row->id; ?>');" title="Gerenciar contratosr"><i
                            class="glyphicon glyphicon-plus"></i> Contratos
                </button>
            </td>
        </tr>
    <?php endforeach; ?>
