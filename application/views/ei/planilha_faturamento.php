...
<div class="container-fluid">
	...
	<table width="100%">
		<tr>
			<td style="vertical-align: top;" width="<?php echo $is_pdf ? '100%' : '50%'; ?>">
		...
		<table>
			<tr>
				...
				<td class="text-center text-danger">
					...
					<br>
					<p>
					<h5 class="text-danger"><?= $supervisor->nome_supervisor ?></h5>
					<?= $supervisor->funcao_supervisor ?><br>
					<?= $supervisor->email_supervisor ?><br>
