                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <input type="hidden" value="<?= $idAlunoCurso; ?>" name="id_aluno_curso"/>
                                <div class="form-body">
                            ...
                            <form action="#" id="form_turma" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input name="nota" class="form-control text-right nota" type="text">
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<?php require_once APPPATH . "views/end_js.php"; ?>
    ...
    <script>
                ...
                rowGroup: {
                    ...
                    startRender: function (rows, group) {
                        ...
                        return '<strong>Ano/semestre: </strong>' + group + '&emsp;' +
                            ...
                            '<div class="pull-right">' + col[9] + '</div>';
                    },
                    dataSrc: 0
                },
                ajax: {
                    url: '<?php echo site_url('ei/turmas/ajax_list/') ?>',
                    type: 'POST',
                    data: function (d) {
                        d.busca = $('#busca').serialize();
                        d.id_aluno_curso = '<?= $idAlunoCurso ?>';
                        return d;
                    }
                },
                columnDefs: [
        ...
        function atualizarFiltro() {
            $.ajax({
                url: '<?php echo site_url('ei/turmas/atualizar_filtro/') ?>',
                type: 'POST',
                dataType: 'JSON',
        ...
        function atualizar_estrutura() {
            $.ajax({
                url: '<?php echo site_url('ei/turmas/ajax_estrutura/') ?>',
                type: 'POST',
                dataType: 'json',
                data: {
                    depto: $('#depto').val(),
        ...
        function atualizar_escolas() {
            $.ajax({
                url: '<?php echo site_url('ei/turmas/atualizar_escolas/') ?>',
                type: 'POST',
                dataType: 'html',
                data: {
        ...
        function atualizar_periodos() {
            ...
            if (id.length > 0) {
                $.ajax({
                    url: '<?php echo site_url('ei/turmas/atualizar_periodos/') ?>',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        id: id
        ...
        function edit_semestre(id) {
            ...
            $.ajax({
                url: '<?php echo site_url('ei/turmas/ajax_edit/') ?>',
                type: 'POST',
                dataType: 'JSON',
                data: {id: id},
        ...
        function edit_turma(id) {
            ...
            $.ajax({
                url: '<?php echo site_url('ei/turmas/ajax_editTurma/') ?>',
                type: 'POST',
                dataType: 'JSON',
                data: {id: id},
                success: function (json) {
        ...
        function save_semestre() {
            ...
            if (save_method === 'add') {
                url = '<?php echo site_url('ei/turmas/ajax_add') ?>';
            } else {
                url = '<?php echo site_url('ei/turmas/ajax_update') ?>';
            }
        ...
        function save_turma() {
            ...
            if (save_method === 'add') {
                url = '<?php echo site_url('ei/turmas/ajax_addTurma') ?>';
            } else {
                url = '<?php echo site_url('ei/turmas/ajax_updateTurma') ?>';
            }
