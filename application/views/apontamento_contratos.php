        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-success" onclick="add_contrato()"><i class="glyphicon glyphicon-plus"></i>
                        Adicionar contrato
                    </button>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('apontamento_contratos/ajax_list/') ?>",
                    "type": "POST",
                    data: function (d) {
        ...
        function atualizarFiltro() {
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/atualizar_filtro/') ?>",
                type: "POST",
                dataType: "JSON",
        ...
        function atualizar_estrutura() {
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/ajax_estrutura/') ?>",
                type: "POST",
                dataType: "json",
                data: {
                    depto: $('#depto').val(),
        ...
        function atualizar_servicos(data_reajuste) {
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/ajax_servicos/') ?>",
                type: "POST",
                dataType: "JSON",
                data: {
        ...
        function edit_contrato(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/ajax_edit/') ?>",
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function (data) {
        ...
        function edit_unidades(id) {
            ...
            //Ajax Load data from ajax
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/ajax_unidades/') ?>",
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function (data) {
        ...
        function edit_reajuste(id) {
            ...
            //Ajax Load data from ajax
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/ajax_reajuste/') ?>",
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function (data) {
        ...
        function save() {
            ...
            if (save_method === 'add') {
                url = "<?php echo site_url('apontamento_contratos/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('apontamento_contratos/ajax_update') ?>";
            }
        ...
        function save_unidades() {
            ...
            // ajax adding data to database
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/save_unidades') ?>",
                type: "POST",
        ...
        function save_servicos() {
            ...
            // ajax adding data to database
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/save_servicos') ?>",
                type: "POST",
        ...
        function save_reajuste() {
            ...
            // ajax adding data to database
            $.ajax({
                url: "<?php echo site_url('apontamento_contratos/save_reajuste') ?>",
                type: "POST",
