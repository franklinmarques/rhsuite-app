    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('pesquisa_alternativas/ajax_list/' . $id_modelo) ?>",
                    "type": "POST"
                },
        ...
        function edit_pergunta(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('pesquisa_alternativas/ajax_edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function save() {
            ...
            if (save_method === 'add') {
                url = "<?php echo site_url('pesquisa_alternativas/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('pesquisa_alternativas/ajax_update') ?>";
            }
        ...
        function delete_pergunta(id) {
            if (confirm('Deseja remover?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('pesquisa_alternativas/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data) {
