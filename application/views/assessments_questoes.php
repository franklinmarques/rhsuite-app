            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 5px; background-color: #eee;">
                        <li><a href="<?= site_url('assessments_modelos') ?>">Modelos de assessment</a></li>
                        <li class="active">Questões para avaliação <?= $tipo ?></li>
                    </ol>
                    <div class="row">
                        <div class="col-md-6">
                            <button class="btn btn-info" onclick="add_pergunta()">
                                <i class="glyphicon glyphicon-plus"></i> Adicionar pergunta
                            </button>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-defaault" data-dismiss="modal">Cancelar</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="btnLimpar" onclick="limpar_resposta()" class="btn btn-warning">
                                Limpar tudo
                            </button>
...
?>
    ...
    <script>
        $(document).ready(function () {
            document.title = 'CORPORATE RH - LMS - Questões para avaliação <?= $tipo ?>';
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('assessments_questoes/ajax_list/' . $id_modelo) ?>",
                    "type": "POST"
                },
            ...
            table2 = $('#table2').DataTable({
                ...
                // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('assessments_questoes/ajax_listResposta/' . $id_modelo) ?>",
                    "type": "POST"
                },
                //Set column definition initialisation properties.
                "columnDefs": [
        ...
        function edit_pergunta(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('assessments_questoes/ajax_edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function editar_resposta() {
            ...
            //Ajax Load data from ajax
            $.ajax({
                url: "<?php echo site_url('assessments_questoes/ajax_editResposta/' . $id_modelo) ?>",
                type: "GET",
                dataType: "JSON",
                success: function (data) {
        ...
        function save() {
            ...
            if (save_method === 'add') {
                url = "<?php echo site_url('assessments_questoes/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('assessments_questoes/ajax_update') ?>";
            }
        ...
        function salvar_resposta() {
            ...
            // ajax adding data to database
            $.ajax({
                url: "<?php echo site_url('assessments_questoes/ajax_updateResposta') ?>",
                type: "POST",
        ...
        function delete_pergunta(id) {
            if (confirm('Deseja remover?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('assessments_questoes/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data) {
