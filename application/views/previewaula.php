                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <a class="btn btn-default btn-sm"
                           href="<?php echo site_url('home/paginascurso/' . $row->curso); ?>"
                    ...
                    <div class="panel-body" style="height:100%;">
                        ...
                        <?php } else if ($row->modulo == "arquivos-pdf") { ?>
                            <iframe src="https://docs.google.com/gview?embedded=true&url=<?php echo base_url('arquivos/pdf/' . convert_accented_characters($row->pdf)); ?>" style="width:100%; height:600px; margin:0;" frameborder="0"></iframe>
                            <?php
