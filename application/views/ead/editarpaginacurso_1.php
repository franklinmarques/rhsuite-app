                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right">
                                <p>
                                    ...
                                    <input id="arquivo_audio" name="arquivo_audio" type="hidden" value="<?= (!empty($row->gravacao_audio) ? $row->gravacao_audio : ''); ?>" readonly>
                        ...
                        <div id="box-quiz" style="display: <?= ($row->modulo != 'quiz' ? 'none' : 'block'); ?>;">
                            <div class="row">
                                <div class="col-sm-6 col-lg-5">
                                    <button class="btn btn-success" onclick="add_questao()"><i class="glyphicon glyphicon-plus"></i> Adicionar questao</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-lg-2 controls">
                                    <input type="number" name="nota_aprovacao" value="" min="0" max="100" step="1" class="form-control"/>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="row" id="box-quiz2" style="display:none;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9 col-lg-10 controls">
                                                            ...
                                                            <span class="help-inline" style="color: #000;">
                                                                <input type="checkbox" name="corretas[<?php echo $alternativa->id; ?>]"<?= ($alternativa->correta ? ' checked="checked"' : ''); ?> value="1"/> 
                                                                Alternativa correta
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-lg-10 controls">
                                                    <a href="#" id="adicionar-alternativa-<?php echo $pergunta->id; ?>"
                                                       class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Adicionar alternativa
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
                                <div class="col-sm-9 col-lg-10 controls">
                                    <a href="#" class="btn btn-success btn-xs adicionar-pergunta"<?php echo (count($quizperguntas) == 0 ? ' style="display: none;"' : ''); ?>>
                                        <i class="fa fa-plus"></i> Adicionar perguntaaa</a>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="box-atividades" style="display: <?= ($row->modulo != "atividades" ? 'none' : 'block'); ?>;">
                            ...
                            <br/>
                            <div class="col-sm-12">
                                <table id="table_atividades" class="table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Resumo descritivo da questão</th>
                                            <th>Modelo da questão</th>
                        ...
                        <div class="row" id="box-atividades2"<?= ($row->modulo != "atividades" ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
                                    ...
                                    <div id="box-<?php echo $pergunta->id; ?>"
                                        ...
                                        <div id="box-alternativa-<?php echo $pergunta->id; ?>"<?= ($pergunta->tipo != 1 ? ' style="display: none;"' : ''); ?> >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-lg-10 controls">
                                                    <a href="#" id="adicionar-alternativa-<?php echo $pergunta->id; ?>" class="btn btn-success btn-xs">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
                                <div class="col-sm-9 col-lg-10 controls">
                                    <a href="#" class="btn btn-success btn-xs adicionar-pergunta-atividade"<?php echo (count($atividadesperguntas) == 0 ? ' style="display: none;"' : ''); ?>>
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <span class="input-group-addon btn btn-default btn-file">
                                            ...
                                            <input type="file" name="arquivoVideo" placeholder="Apenas vídeos .mp4 são suportados!"
                                                   value="<?= (!empty($row->conteudo_url) ? $row->arquivoVideo : ''); ?>" accept="video/mp4"/>
                                        </span>
                                        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remover</a>
                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <audio id="audio" controls style="width: 100%;" src="<?= (!empty($row->audio) ? base_url("arquivos/media/$row->gravacao_audio") : ''); ?>"></audio>
                        <div class="radio">
                            <label>
                                <input type="radio" name="audio_modo" id="audio_modo_2" value="2"> Enviar arquivo de áudio
                            </label>
                        </div>
                        <div id="modo_2">
                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                ...
                                <span class="input-group-addon btn btn-default btn-file">
                                    <span class="fileinput-new">Selecionar arquivo</span>
                                    <span class="fileinput-exists">Alterar</span>
                                    <input type="file" name="audio" placeholder="Apenas audio .mp3 são suportados!" accept="audio/mp3"/>
                                </span>
                                <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remover</a>
                            </div>
                        </div>
