                ...
                <section class="panel">
                    <header class="panel-heading">
                        <span><i class="fa fa-plus"></i>
                            <strong>&nbsp;Cadastrar página do treinamento - <?php echo $row->nome; ?></strong></span>
...
<script>
    $(document).ready(function () {
        document.title = 'CORPORATE RH - LMS - Treinamento - <?= $row->nome ?>';
    });
</script>
...
<script>
    ...
    $(document).ready(function () {
        table_quiz = $('#table_quiz').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('ead/pagina_curso/ajax_quiz') ?>",
                "type": "POST",
                timeout: 9000
            },
...
//                },
        ...
        table_atividades = $('#table_atividades').DataTable({
            ...
            // Load data for the table's content from an Ajax source
            "ajax": {
                "url": "<?php echo site_url('ead/pagina_curso/ajax_atividades') ?>",
                "type": "POST",
                timeout: 9000
            },
            //Set column definition initialisation properties.
    ...
    $(function () {
        ...
        $('input[name=modulo]').change(function () {
            ...
            if (moduloSelecionado === 'biblioteca') {
                getBiblioteca($('#html-biblioteca'), '<?php echo site_url('ead/pagina_curso/ajax_biblioteca'); ?>/' + $('input[name=modulo]:checked').data('tipo'), $('select[name=categoriabiblioteca]').val(), $('input[name=titulobiblioteca]').val(), $('input[name=tagsbiblioteca]').val());
            }
