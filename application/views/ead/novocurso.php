                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7 controls">
                                <input id="competencias_genericas" name="competencias_genericas" type="text"
                                       class="tags"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7 controls">
                                <input id="competencias_especificas" data-role="tagsinput"
                                       name="competencias_especificas" type="text" class="tags"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7 controls">
                                <input id="competencias_comportamentais" data-role="tagsinput"
                                       name="competencias_comportamentais" type="text" class="tags"/>
                            </div>
                        </div>
                        <div class="form-group">
