							...
							<div style="float:right; margin-top: -5px;">
								...
								<?php if ($paginaatual->anterior > $curso->pagina_inicial): ?>
									<a class="btn btn-primary btn-sm" style="padding: 1px 6px; font-size: 16px;"
									   href="<?php echo site_url('ead/treinamento/acessar/' . $this->uri->rsegment(3) . '/' . $paginaatual->anterior); ?>">
								...
								<?php else: ?>
									<a class="btn btn-primary btn-sm" style="padding: 1px 6px; font-size: 16px;"
									   href="<?php echo site_url('ead/treinamento/acessar/' . $this->uri->rsegment(3) . '/' . $paginaatual->proxima); ?>">
										<span class="hidden-xs hidden-sm">Próximo </span><i
											class="glyphicon glyphicon-arrow-right"></i>
									</a>
								<?php endif; ?>
							...
							<?php case 'url': ?>
								...
								<?php else: ?>
									<div class="col-md-12">
										<div class="col-md-8">
											<source
												src="<?php echo base_url('arquivos/videos/' . $paginaatual->arquivo_video); ?>"
												type="video/mp4">
										</div>
										<div class="col-md-4">
											<?php echo $paginaatual->conteudo; ?>
...
<script>
    ...
    function atualizarTempoEstudo(id_curso, id_pagina) {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url('ead/treinamento/atualizarTempoEstudo'); ?>',
            dataType: 'JSON',
            data: {
                id_curso: id_curso,
                id_pagina: id_pagina
