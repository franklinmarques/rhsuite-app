                ...
                <td>
                    <?php if ($this->session->userdata('tipo') == "administrador" || $row->id_empresa == $this->session->userdata('id')): ?>
                        ...
                        <?php if ($row->qtde_paginas > 0): ?>
                            <a class="btn btn-info btn-sm" href="<?= site_url('ead/cursos/preview/' . $row->id); ?>" target="_blank" >
                    ...
                    <?php else: ?>
                        <?php if ($row->tipo_curso > 0): ?>
                            <button class="btn btn-default btn-sm" onclick="detalhesCursos(<?= $row->id; ?>);" style="background-color: #3F5AA5;">
                        ...
                        <?php elseif ($row->tipo_curso == 0): ?>
                            ...
                            <button class="btn btn-default btn-sm" onclick="solicitaCursos(<?= $row->id; ?>);" style="background-color: #B40ECF;">
        ...
        <div class='modal-content'>
            <div class='modal-header'>
                <h4 class='modal-title' id='myModalLabel' style='text-align: center !important;'>
                    ...
                    <a href="javascript:void(0);" class='fa fa-remove' data-dismiss='modal' id='fechaModal' style="float: right;"></a>
                </h4>
            </div>
