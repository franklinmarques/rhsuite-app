            ...
            <div class="col-md-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <span class="tools pull-right">
                            <a class="btn btn-default btn-sm"
                               href="<?php echo site_url('ead/cursos_funcionario/index/' . $row->id); ?>"
                    ...
                    <div class="panel-body">
                        <?php echo form_open('ead/cursos_funcionario/ajax_add/' . $row->id, 'data-aviso="alert" class="form-horizontal ajax-upload" autocomplete="off"'); ?>
                        <div class="form-group">
                            <label class="control-label col-md-2">Tipo treinamento</label>
                            <div class="col-md-3">
                                <label class="radio-inline">
                                    <input type="radio" name="tipo_treinamento" value="E" checked=""> EAD
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="tipo_treinamento" value="P"> Presencial
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 col-md-3 col-lg-2">
                                <div class="input-group">
                                    <input name="nota_aprovacao" id="nota_aprovacao" value=""
                            ...
                            <div class="col-md-2">
                                <input class="data form-control text-center input_presencial"
                                       name="avaliacao_presencial" type="number" value="" min="0" max="100" disabled="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-8 controls">
                                <input name="nome_fornecedor" placeholder="Nome do fornecedor"
                                       class="form-control input_presencial" type="text" value="" disabled="">
                            </div>
                        </div>
