                ...
                <div class="col-md-12">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="icon-reorder"></i> Cadastrar Treinamento na Empresa - <?php echo $row->nome; ?>
                        </header>
                        <div class="panel-body">
                            <?php echo form_open('home/novocursoempresa_json/' . $row->id, 'data-aviso="alert" class="form-horizontal ajax-upload"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-lg-4">
                                    <input class="form-control form-control-inline input-medium default-date-picker"
                                           size="16" type="text" value="<?= date('d/m/Y'); ?>" name="data_maxima"/>
