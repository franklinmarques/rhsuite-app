<div class="form-group hidden-md hidden-lg">
    ...
    <br>
    <button class="btn btn-primary btn-xs" type="submit"><i class="fa fa-key"></i></button>
    <small> Atualizar Licença</small>
    <hr>
</div>
                ...
                <?php } else { ?>
                    ...
                    <a class="btn btn-primary btn-sm"
                       href="<?php echo site_url('home/editarcursoempresa/' . $this->uri->rsegment(3) . '/' . $row->id); ?>">
                        <i class="fa fa-key"></i><span class="hidden-xs hidden-sm"> Atualizar Licença</span>
                    </a>
                <?php } ?>
            </td>
        </tr>
