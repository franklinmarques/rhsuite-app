                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <label class="radio-inline">
                                                <input type="radio" name="modulo" autocomplete="off"
                                                       value="pdf"<?= ($row->modulo == "pdf" ? ' checked="checked"' : ''); ?> />
                                                <i class="fa fa-file-word-o"></i> Arquivos (Word, PorwerPoint, Bloco de
                                                Notas, PDF)
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="modulo" autocomplete="off"
                                                       value="url"<?= ($row->modulo == "url" ? ' checked="checked"' : ''); ?> />
                                ...
                                <div class="col-md-3 text-right">
                                    <p>
                                        ...
                                        <input id="gravacao_audio" name="gravacao_audio" type="hidden"
                            ...
                            <div class="row url"
                                 style="display: <?= (in_array($row->modulo, array('url')) ? 'block' : 'none'); ?>;">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input type="text" name="url" placeholder="Endereço da URL"
                                                   value="<?= (!empty($row->url) ? $row->url : ''); ?>"
                                                   class="form-control" <?= ($row->modulo == 'url' && empty($row->url) ? 'disabled=""' : ''); ?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row pdf url"
                                 style="display: <?= (in_array($row->modulo, array('pdf', 'url')) ? 'block' : 'none'); ?>;">
                                <div class="form-group">
                                    <label class="col-sm-3 col-lg-2 control-label">Arquivo</label>
                                    <div class="pdf col-sm-8 col-lg-9 controls"
                                         style="display: <?= (in_array($row->modulo, array('pdf')) ? 'block' : 'none'); ?>;">
                                    ...
                                    <div class="url col-sm-8 col-lg-9 controls"
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <div class="form-control <?= ($row->modulo == 'url' && $row->arquivo_video ? '' : 'disabled'); ?>"
                                            ...
                                            <input type="file" name="arquivo_video"
                                                   ...
                                                   value="<?= ($row->arquivo_video ? $row->arquivo_video : ''); ?>"
                                                   accept="video/mp4"/>
                                        </span>
                                            <a href="#" class="input-group-addon btn btn-default fileinput-exists"
                                               data-dismiss="fileinput">Remover</a>
                            ...
                            <div class="row quiz atividades"
                                 style="display: <?= (in_array($row->modulo, array('quiz', 'atividades')) ? 'block' : 'none'); ?>;">
                            ...
                            <div class="row quiz atividades"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3 col-lg-2 controls">
                                        <input type="number" name="nota_corte" value="<?= $row->nota_corte ?>" min="0"
                                    ...
                                    <div class="col-sm-6 col-lg-5">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"
                                                       name="questao_aleatoria"<?= in_array($row->aleatorizacao, array('P', 'T')) ? ' checked=""' : '' ?>/>
                                        ...
                                        <div class="checkbox disabled">
                                            <label>
                                                <input type="checkbox"
                                                       name="alternativa_aleatoria"<?= in_array($row->aleatorizacao, array('A', 'T')) ? ' checked=""' : '' ?>/>
                            ...
                            <div class="row ckeditor url"
                                 style="display: <?= (in_array($row->modulo, array('ckeditor', 'url')) ? 'block' : 'none'); ?>;">
                                <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="autoplay"
                                                           value="1"<?= $row->autoplay ? ' checked=""' : '' ?>> Execução
                                                    automática
                                                </label>
                                            </div>
                                            <hr>
...
?>
    ...
    <script>
        ...
        function save_questao() {
            ...
            $('#btnSaveQuestao').text('Adicionar à lista').attr('disabled', false);
        }
