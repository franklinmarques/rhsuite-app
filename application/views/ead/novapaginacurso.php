            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <a class="btn btn-default btn-sm" href="<?php echo site_url('ead/pagina_curso/index/' . $row->id); ?>" style="float: right; margin-top: -0.6%;">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" autocomplete="off" value="ckeditor" checked=""/>
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" autocomplete="off" value="atividades"/>
                            ...
                            <div class="col-md-3 text-right">
                                <p>
                                    ...
                                    <input id="gravacao_audio" name="gravacao_audio" type="hidden" value="" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-lg-9 controls">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="url" placeholder="Endereço da URL" value="" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="pdf col-sm-8 col-lg-9 controls">
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <span class="input-group-addon btn btn-default btn-file">
                                            ...
                                            <input type="file" name="pdf" placeholder="hfggfs" accept=".pdf,.doc,.docx,.txt,.ppt,.pptx"/>
                                        </span>
                                ...
                                <div class="url col-sm-8 col-lg-9 controls">
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <span class="input-group-addon btn btn-default btn-file">
                                            ...
                                            <span class="fileinput-new">Selecionar arquivo</span>
                                            <span class="fileinput-exists">Alterar</span>
                                            <input type="file" name="arquivo_video" placeholder="Apenas vídeos .mp4 são suportados!" value="" accept="video/mp4" disabled=""/>
                                        </span>
                                        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remover</a>
                                    </div>
                        ...
                        <div class="row quiz atividades" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-lg-2 controls">
                                    <input type="number" name="nota_corte" value="" min="0" max="100" step="1" class="form-control"/>
                                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="autoplay" value="1"> Execução automática
                                            </label>
                                        </div>
                                        <hr>
                                        <div class="radio">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="audio_modo" id="audio_modo_1" value="1" disabled=""> Gravar áudio usando microfone
                                            </label>
                                        </div>
                                        <div id="modo_1">
                                            <div id="time">
