                        ...
                        <div class="panel-body" style="overflow-y: auto; max-height: 600px; font-size: 12px;">
                            <?php foreach ($paginas->result() as $k => $pagina): ?>
                                <p style="margin: 0 0 5px; overflow:hidden; text-overflow:ellipsis; white-space: nowrap;<?= $pagina->id === $paginaatual->id ? 'background: #758FB0; color: #fff' : '' ?>">
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo site_url('ead/cursos/preview/' . $pagina->curso . '/' . $pagina->ordem); ?>"
                                       title="<?= $pagina->titulo; ?>">
                ...
                <div class="col-sm-10" style="padding-left: 10px;">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <?php case 'quiz': ?>
                                <?php echo form_open('ead/treinamento/avaliar_atividade/', 'data-aviso="alert" class="ajax-simple" id="respostaAtividades"'); ?>
                                        ...
                                        <?php if ($pergunta->tipo == 1) : ?>
                                            <ul class="list-unstyled">
                                                <?php foreach ($pergunta->alternativas as $row): ?>
                                                    <li>
                                                        <input type="radio"
                                                               name="pergunta[<?php echo $pergunta->id; ?>]"
                                                               class="alternativa" value="<?php echo $row->correta; ?>"
                                                               data-pergunta="<?php echo $pergunta->id; ?>"/>
                                                        <?php echo $row->alternativa; ?>
                                                    </li>
                                                <?php endforeach; ?>
                                            </ul>
                                            <div id="alternativa-correta-<?php echo $pergunta->id; ?>"
                                                 class="alert alert-success" style="display: none;">
                                                <?php echo $pergunta->respostacorreta; ?>
                                            </div>
                                            <div id="alternativa-errada-<?php echo $pergunta->id; ?>"
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="form-group">
                                                <a href="javascript: void(0);"
                                                   class="btn btn-success btn-xs dissertativa"
                                                   data-pergunta="<?php echo $pergunta->id; ?>">
                                                    <i class="glyphicon glyphicon-eye-open"></i> Visualizar resposta</a>
                                            </div>
                                            <div id="alternativa-dissertativa-<?php echo $pergunta->id; ?>"
                                                 class="alert alert-success" style="display: none;">
                                                <?php echo $pergunta->respostacorreta; ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <?php endforeach; ?>
                                <button class="btn btn-success" id="enviaResposta" type="button">Enviar respostas
                                </button>
                            ...
                            <?php case 'video-youtube': ?>
                                ...
                                <?php else: ?>
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <source src="<?php echo base_url('arquivos/videos/' . $paginaatual->arquivoVideo); ?>"
                                                    type="video/mp4">
                                        </div>
                                        <div class="col-md-4">
                                            <?php echo $paginaatual->conteudo; ?>
...
//                content: '<div class="alert alert-info clearfix"><audio id="player" controls="" src="<?= base_url('arquivos/media/' . $paginaatual->audio); ?>"></audio></div>'
    ...
    function finalizaPagina(curso, pagina) {
        if (curso > 0 && pagina > 0) {
            $.ajax({
                'url': '<?php echo site_url('ead/treinamento/finalizar_pagina'); ?>/' + curso + '/' + pagina,
                'dataType': 'json',
                'success': function (json) {
                    if (json.total < 100) {
                        window.location.href = '<?= site_url('ead/cursos/preview/' . $this->uri->rsegment(3)); ?>/' + json.proxima;
                    }
                    if (json.total >= 100) {
