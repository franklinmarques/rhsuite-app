        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-success" onclick="add_questao()"><i class="glyphicon glyphicon-plus"></i>
                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="nome" placeholder="Digite o nome do modelo de questão"
                            ...
                            <form action="#" id="form_conteudo" class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="conteudo" id="conteudo" class="form-control" rows="16"
    ...
    <script>
        ...
        function edit_questao(id) {
            ...
            $.ajax({
                ...
                'success': function (json) {
                    $('[name="id"]').val(json.id);
                    $('[name="empresa"]').val(json.id_empresa);
                    ...
                    if (json.aleatorizacao === 'P' || json.aleatorizacao === 'T') {
                        $('[name="perguntas"]').prop('checked', true);
                    }
                    if (json.aleatorizacao === 'A' || json.aleatorizacao === 'T') {
                        $('[name="alternativas"]').prop('checked', true);
                    }
                    $('.aleatorizacao').prop('disabled', json.tipo === '2');
        ...
        function edit_respostas(id) {
            ...
            $.ajax({
                ...
                'success': function (json) {
                    $('#nome').text(json.nome);
                    $('[name="id_questao"]').val(json.id_questao);
                    $('[name="feedback_correta"]').val(json.feedback_correta);
                    $('[name="feedback_incorreta"]').val(json.feedback_incorreta);
                    if (json.tipo === '2') {
