                            ...
                            <div class="panel-group m-bot20" id="accordion">
                                <div class="well well-sm">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <?php echo form_open('ead/cursos/ajax_disponiveis', 'data-html="html-solicitar-cursos" class="form-horizontal" style="margin-top: 15px;" id="busca-solicitar-cursos"'); ?>
                                            <div class="form-group">
                                                <div class="col-sm-2 col-lg-3">
                                                    <select class="form-control input-sm" name="categoria">
                                                        <option value="" selected="">Todas as Categorias</option>
                                                        <?php foreach ($categorias as $curso) : ?>
                                                ...
                                                <div class="col-sm-3 col-lg-4">
                                                    <select class="form-control input-sm" name="area_conhecimento">
                                                        <option value="" selected="">Todas as Áreas de Conhecimeto
                                                        </option>
                                                        <?php foreach ($areas_conhecimento as $area_conhecimento) : ?>
