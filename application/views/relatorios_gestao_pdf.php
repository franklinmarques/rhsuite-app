...
<div class="container-fluid">
    ...
    <table class="table table-condensed gestao">
        ...
        <tr>
            <th colspan="3">
                <?php if ($is_pdf == false): ?>
                    <h2 class="text-center">RELATÓRIO DE GESTÃO</h2>
                <?php else: ?>
                    <h3 class="text-center">RELATÓRIO DE GESTÃO</h3>
                <?php endif; ?>
            </th>
        </tr>
        </thead>
    ...
    <table class="table table-condensed dados">
        <tbody>
        <tr>
            <th class="active">Indicadores:</th>
        </tr>
        <tr>
            <td><p><?= nl2br($indicadores); ?></p><br></td>
        </tr>
        <tr>
            <th class="active">Riscos/oportunidades:</th>
        </tr>
        <tr>
            <td><p><?= nl2br($riscos_oportunidades); ?></p><br></td>
        </tr>
        <tr>
            <th class="active">Ocorrências:</th>
        </tr>
        <tr>
            <td><p><?= nl2br($ocorrencias); ?></p><br></td>
        </tr>
        <tr>
            <th class="active">Necessidades/investimentos:</th>
        </tr>
        <tr>
