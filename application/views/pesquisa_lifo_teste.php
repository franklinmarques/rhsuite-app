...
<head>
    ...
    <title>CORPORATE RH - LMS - Orientações Para a Vida</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <form id="form" class="form-horizontal" autocomplete="off">
                                            <?php foreach ($perguntas as $k => $pergunta): ?>
                                                <div class="panel panel-default">
                                                    <div id="pergunta_<?= $k + 1 ?>" class="panel-heading"
                                                         style="background: #eee !important;">
                                                        <h5 style="color: #333;"><?php echo $pergunta->pergunta; ?></h5>
                                                    </div>
                                                    <table class="table">
                                                        <thead>
                                                        <tr>
                                                            <th width="100%">Respostas</th>
                                                            <th class="text-center">Nota/prioridade</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td nowrap="">
                                                                    <label class="radio-inline">
                                                                        <?php echo form_radio(['name' => "valor[$alternativa->id]", 'value' => 1, 'checked' => $alternativa->resposta === '1', 'class' => "pergunta_$pergunta->id"]); ?>
                                                                        1
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <?php echo form_radio(['name' => "valor[$alternativa->id]", 'value' => 2, 'checked' => $alternativa->resposta === '2', 'class' => "pergunta_$pergunta->id"]); ?>
                                                                        2
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <?php echo form_radio(['name' => "valor[$alternativa->id]", 'value' => 3, 'checked' => $alternativa->resposta === '3', 'class' => "pergunta_$pergunta->id"]); ?>
                                                                        3
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <?php echo form_radio(['name' => "valor[$alternativa->id]", 'value' => 4, 'checked' => $alternativa->resposta === '4', 'class' => "pergunta_$pergunta->id"]); ?>
                                                                        4
                                                                    </label>
                                                                </td>
                                                            </tr>
...
<script>
    ...
    $('input[type="radio"]').on('change', function () {
        ...
        $('input[type="radio"].' + classe + '[value="' + valor + '"]').prop('checked', false);
    ...
    function enviar() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url('pesquisa_lifo/finalizar/' . $this->uri->rsegment(3)); ?>',
            data: $('#form').serialize(),
            dataType: 'json',
            error: function () {
