...
<section id="main-content">
    <section class="wrapper">
        ...
        <!-- page start-->
        <!--<ul class="breadcrumbs-alt" role="tablist">
            <li>
                <a href="#departamento" aria-controls="departamento" role="tab" data-toggle="tab">Departamentos</a>
            </li>
            <li>
                <a class="active-trail active" href="#area" aria-controls="area" role="tab" data-toggle="tab">Áeras</a>
            </li>
            <li>
                <a class="current" href="#setor" aria-controls="setor" role="tab" data-toggle="tab">Setores</a>
            </li>
        </ul>-->

        <ul class="phil phil-tabs nav-justified" role="tablist">
            <li role="presentation" class="active">
                <a href="#departamento" aria-controls="departamento" role="tab" data-toggle="tab">Departamento</a>
            </li>
            <li role="presentation" class="disabled">
                <a href="#area" aria-controls="area" role="tab" data-toggle="tab">Área</a>
            </li>
            <li role="presentation" class="disabled">
                <a href="#setor" aria-controls="setor" role="tab" data-toggle="tab">Setor</a>
            </li>
        </ul>
        ...
        <div role="tabpanel" class="tab-pane" id="departamento">
