...
<div class="row">
    <div class="col-md-12">
        <button class="btn btn-success" onclick="add_integracao()"><i class="glyphicon glyphicon-plus"></i> Adicionar
            novo
            programa de integração
        </button>
        <br/>
        <br/>
        <table id="table_integracao" class="table table-striped table-bordered"
...
<!-- Bootstrap modal -->
<div class="modal fade" id="modal_integracao" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h3 class="modal-title">Formulario de Programa de Integração</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form_integracao" class="form-horizontal">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSaveIntegracao" onclick="save_integracao()" class="btn btn-primary">
                    Salvar
                </button>
...
<script>
    ...
    //datatables
    table = $('#table_integracao').DataTable({
