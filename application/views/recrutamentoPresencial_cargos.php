            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th rowspan="2">Req.</th>
                            <th colspan="2" class="text-center">Cargo/função</th>
                            <th colspan="2" class="text-center">Candidato</th>
                            <th colspan="2" class="text-center">Testes seletivos online</th>
                            <th colspan="2" class="text-center">Testes seletivos presenciais</th>
                        </tr>
                        <tr>
                            <th>Nome</th>
                            <th>Ação</th>
                        ...
                        <div class="modal-body form">
                            ...
                            <form action="#" id="form_candidato" class="form-horizontal">
                                <div class="form-body" style="padding: 0 20px 20px;">
                                    <input type="hidden" value="" name="id"/>
                                    <input type="hidden" value="" name="id_requisicao"/>
                                    <div class="row form-group">
                                        <div class="col-md-12">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('recrutamentoPresencial_cargos/ajax_list/' . $requisicao) ?>",
                    "type": "POST"
                },
                rowsGroup: [0, 1, 2],
        ...
        function aprovar_candidato(id) {
            $.ajax({
                url: "<?php echo site_url('recrutamentoPresencial_cargos/aprovarCandidto') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function () {
        ...
        function desaprovar_candidato(id) {
            $.ajax({
                url: "<?php echo site_url('recrutamentoPresencial_cargos/desaprovarCandidto') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function () {
