    ...
    <htmlpageheader name="myHeader">
        <table id="table" class="table table-condensed">
            ...
            <tr>
                ...
                <?php if ($is_pdf == false): ?>
                    <td nowrap>
                        <button onclick="fechar_mes()" class="btn btn-sm btn-primary" id="fechar_mes"
        ...
        <?php if ($contrato): ?>
            ...
            <?php if ($postos): ?>
                <table id="servicos" class="table table-bordered table-condensed">
                    ...
                    <tbody>
                    <?php if (count($servicos->compartilhados) > 0): ?>
                        <tr class="active">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><strong><?= number_format($servicos->total, 2, ',', '.') ?></strong>
                        </td>
                    </tr>
                    <?php if (count($servicos->nao_compartilhados) > 0): ?>
                        <!-- <tr class="active">
            ...
            <div style="float: left; width: 64%;">
                <table id="reajuste" class="table table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="totalizacao_1"<?= $calculo_totalizacao === '1' ? '' : ' style="display: none;"'; ?>>
                                <strong><?= number_format($reajuste->total_liquido, 2, ',', '.') ?></strong>
                            </span>
                            <span class="totalizacao_2"<?= $calculo_totalizacao === '2' ? '' : ' style="display: none;"'; ?>>
