                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    <div class="row form-group">
                                        <label class="control-label col-md-3">Nome do teste</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row form-group">
                                        <label class="control-label col-md-3">Data do teste</label>
                                    ...
                                    <!--<div class="row form-group">
                                        <label class="control-label col-md-3">Data e hora </label>
                                        <div class="col-md-9 form-inline">
                                    ...
                                    <div class="row form-inline form-group">
                                        <label class="control-label col-md-3">Nota de aproveitamento<br>(0 a
                                            100)</label>
                                        <div class="col-md-9">
        ...
        function edit_teste(id) {
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    $('[name="nota_aproveitamento"]').val(json.nota_aproveitamento);
