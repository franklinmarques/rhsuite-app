        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-info" onclick="add_avaliacao()"><i class="glyphicon glyphicon-plus"></i>
                        Adicionar avaliação
                    </button>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="checkbox" style="padding-top: 0px; padding-bottom: 0px;">
                                <label>
                                    <input type="checkbox" id="status_ativo" value="1" onchange="reload_table();">
                                    Mostrar apenas avaliações ativas
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="nome" id="nome" placeholder="Nome da avaliação"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="checkbox">
                                                <label>
                                                    <input name="ativo" type="checkbox" value="1"> Ativo
                                                </label>
                                            </div>
                                        </div>
                                    </div>
...
?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    ...
                    "type": "POST",
                    data: function (d) {
                        d.ativo = ($('#status_ativo').is(':checked') ? 1 : 0);
                        return d;
                    }
                },
        ...
        function add_avaliacao() {
            ...
            $('#modal_form [name="ativo"]').prop('checked', true);
        ...
        function edit_avaliacao(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('[name="ativo"]').prop('checked', data.ativo === '1');
