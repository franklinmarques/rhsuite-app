            ...
            <div class="col-md-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <?php echo form_open('home/novocurso_json', 'data-aviso="alert" class="form-horizontal ajax-upload"'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="categoria" id="categoria" class="form-control" onkeydown="autoComplete('#categoria', 'getCategorias')"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="area_conhecimento" id="area_conhecimento" class="form-control" onkeydown="autoComplete('#area_conhecimento', 'getAreaConhecimento')"/>
