                ...
                <section class="panel">
                    <div class="panel-body" style="padding-bottom: 0px;">
                        ...
                        <ul class="nav nav-pills nav-stacked mail-nav">
                            ...
                            <li class="active"><a href="<?php echo site_url('email/saida'); ?>"> <i
                                        class="fa fa-send"></i>
                                    Caixa de Saída</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-sm-9" style="margin: 0; padding-left: 0;">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                        <h4 class="gen-case">Mensagens Enviadas (<span class="total">0</span>)
                            <?php echo form_open('email/getEmailSaida/', 'data-html="script-emails" class="pull-right mail-src-position" id="busca-emails"'); ?>
                        ...
                        <div class="mail-option">
                            ...
                            <div class="btn-group hidden-phone">
                                ...
                                <ul class="dropdown-menu" style="padding-top: 5px; padding-bottom: 5px;">
                                    <li><a href="#" id="excluirEmail"><i class="icon-trash"></i> Excluir</a></li>
                                </ul>
                            </div>
...
<script>
    $(document).ready(function () {
        document.title = 'CORPORATE RH - LMS - Caixa de Saída';
    });
</script>
<script>
    ...
    $('#excluirEmail').click(function () {
        ...
        $.ajax({
            type: "GET",
            url: "<?= base_url('email/excluirsaida'); ?>",
