...
<script>
    ...
    function save()
    {
        ...
        if (save_method === 'add') {
            url = "<?php echo site_url('apontamento_detalhes/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('apontamento_detalhes/ajax_update') ?>";
        }
    ...
    function delete_evento(id)
    {
        if (confirm('Deseja remover?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('apontamento_detalhes/ajax_delete') ?>",
                type: "POST",
                dataType: "JSON",
                data: {id: id},
                success: function (data)
