            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <span><i class="fa fa-plus"></i><strong>&nbsp;Editar página do treinamento - <?php echo $curso->curso; ?> - <?php echo $row->titulo; ?></strong></span>
                        <a class="btn btn-default btn-sm" href="<?php echo site_url('home/paginascurso/' . $row->curso); ?>" style="float: right; margin-top: -0.6%;">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart('home/editarpaginacurso_json/' . $row->id, 'data-aviso="alert" class="form-horizontal ajax-upload"'); ?>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" value="ckeditor"<?= ($row->modulo == "ckeditor" ? ' checked="checked"' : ''); ?> />
                                            <i class="fa fa-file-zip-o"></i> Objetos (texto, figura, tabela, Flash, links)
                                        </label> 
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" value="quiz"<?= ($row->modulo == "quiz" ? ' checked="checked"' : ''); ?> />
                                            <i class="fa fa-question-circle"></i> Quick quiz
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" value="atividades"<?= ($row->modulo == "atividades" ? ' checked="checked"' : ''); ?> />
                                            <i class="fa fa-pencil"></i> Quiz atividades
                                        </label>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" value="arquivos-pdf"<?= ($row->modulo == "arquivos-pdf" ? ' checked="checked"' : ''); ?> />
                                            <i class="fa fa-file-word-o"></i> Arquivos (Word, PorwerPoint, Bloco de Notas, PDF)
                                        </label>                                        
                                        <label class="radio-inline">
                                            <input type="radio" name="modulo" value="video-youtube"<?= ($row->modulo == "video-youtube" ? ' checked="checked"' : ''); ?> />
                            ...
                            <div class="col-md-3 text-right">
                                <p>
                                    ...
                                    <input id="arquivo_audio" name="arquivo_audio" type="hidden" value="<?= (!empty($row->audio) ? $row->audio : ''); ?>" readonly>
                        ...
                        <div class="row" id="box-ckeditor"<?= ($row->modulo != "ckeditor" ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                                <div class="col-sm-12 col-lg-12 controls">
                                    <textarea name="conteudo" id="conteudo" class="form-control" rows="3"><?= ($row->modulo == 'ckeditor' ? $row->conteudo : ''); ?>
                                    </textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="box-arquivos-pdf"<?= ($row->modulo != "arquivos-pdf" ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-lg-9 controls">
                                    ...
                                    <span class="help-inline"><?= (!empty($row->pdf) ? "<a href='" . base_url('arquivos/pdf/' . convert_accented_characters($row->pdf)) . "' target='_blank'>{$row->pdf}</a>" : ''); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="box-quiz"<?= ($row->modulo != "quiz" ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                                    ...
                                    <div id="box-<?php echo $pergunta->id; ?>"
                                        ...
                                        <div id="box-alternativa-<?php echo $pergunta->id; ?>"<?= ($pergunta->tipo != 1 ? ' style="display: none;"' : ''); ?> >
                                            ...
                                            <div id="alternativas-<?php echo $pergunta->id; ?>">
                                                <?php
                                                foreach ($quizalternativas[$pergunta->id]->result() as $alternativa) {
                                                    ?>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 col-lg-2 control-label">
                                                            Alternativa
                                                        ...
                                                        <div class="col-sm-9 col-lg-10 controls">
                                                            ...
                                                            <span class="help-inline" style="color: #000;"><input type="checkbox"
                                                                                                                  name="corretas[<?php echo $alternativa->id; ?>]"<?= ($alternativa->correta ? ' checked="checked"' : ''); ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
                                <div class="col-sm-9 col-lg-10 controls">
                                    <a href="#" class="btn btn-success btn-xs adicionar-pergunta"<?php echo ($quizperguntas->num_rows() == 0 ? ' style="display: none;"' : ''); ?>>
                                        <i class="fa fa-plus"></i> Adicionar perguntaaa</a>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="box-atividades"<?= ($row->modulo != "atividades" ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
                                ...
                                foreach ($atividadesperguntas->result() as $pergunta) {
                                    ...
                                    <div id="box-<?php echo $pergunta->id; ?>"
                                        ...
                                        <input type="hidden" name="tipoquestao[<?php echo $pergunta->id; ?>]"
                                               data-pergunta="<?php echo $pergunta->id; ?>" value="<?= $pergunta->tipo; ?>"/>

                                        <div id="box-alternativa-<?php echo $pergunta->id; ?>"<?= ($pergunta->tipo != 1 ? ' style="display: none;"' : ''); ?> >
                                            <div id="alternativas-<?php echo $pergunta->id; ?>">
                                                <?php
                                                foreach ($atividadesalternativas[$pergunta->id]->result() as $alternativa) {
                                                    ?>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 col-lg-2 control-label">
                                                            Alternativa
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
                                <div class="col-sm-9 col-lg-10 controls">
                                    <a href="#" class="btn btn-success btn-xs adicionar-pergunta-atividade"<?php echo ($atividadesperguntas->num_rows() == 0 ? ' style="display: none;"' : ''); ?>>
                                        <i class="fa fa-plus"></i> Adicionar pergunta</a>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="box-video-youtube"<?= ($row->modulo != "video-youtube" ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-lg-9 controls">
                                    <span class="help-inline"><?= (!empty($row->pdf) ? "<a href='" . base_url('arquivos/videos/' . convert_accented_characters($row->arquivoVideo)) . "' target='_blank'>{$row->arquivoVideo}</a>" : ''); ?></span>
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        <div class="form-control" data-trigger="fileinput">
                                            <i class="glyphicon glyphicon-file fileinput-exists"></i>
                                            <span class="fileinput-filename"></span>
                                        ...
                                        <span class="input-group-addon btn btn-default btn-file">
                                            <span class="fileinput-new">Selecionar arquivo</span>
                                            <span class="fileinput-exists">Alterar</span>
                                            <input type="file" name="arquivoVideo" placeholder="Apenas vídeos .mp4 são suportados!"
                                                   value="<?= (!empty($row->youtube) ? $row->arquivoVideo : ''); ?>" accept="video/mp4"/>
                                        </span>
                                        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remover</a>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 col-lg-12 controls">
                                    <textarea name="descricaoyoutube" id="descricaoyoutube" class="form-control" rows="3"><?= ($row->modulo == "video-youtube" ? $row->conteudo : ''); ?>
                                    </textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="box-biblioteca"<?= (!in_array($row->modulo, array('mapas', 'simuladores', 'aula-digital', 'jogos', 'livros-digitais', 'infograficos', 'experimentos', 'softwares', 'audios', 'links-externos', 'multimidia')) ? ' style="display: none;"' : ''); ?>>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 col-lg-2 controls">
                                    <select name="categoriabiblioteca" class="form-control input-sm">
                                        ...
                                        <?php foreach ($categoria->result() as $row_): ?>
                                            <option value="<?php echo $row_->id; ?>"<?= ($row->categoriabiblioteca == $row_->id ? ' selected="selected"' : ''); ?>><?php echo $row_->curso; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <audio id="audio" controls style="width: 100%;"
                               src="<?= (!empty($row->audio) ? base_url("arquivos/media/$row->audio") : ''); ?>"></audio>
                        <hr/>
                        <div id="time">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video id="previewVideo" controls style="border: 1px solid #000; height: 240px; width: 100%;">
                            <source id="previewAudio" src="<?= (!empty($row->video) ? base_url("arquivos/media/$row->video") : ''); ?>">
                        </video>
                        <hr/>
    ...
    $(function () {
        ...
        $('input[name=modulo]').change(function () {
            ...
            if (moduloSelecionado === 'biblioteca') {
                getBiblioteca($('#html-biblioteca'), '<?php echo site_url('home/getbiblioteca_html'); ?>/' + $('input[name=modulo]:checked').data('tipo') + '/<?php echo $row->biblioteca; ?>', $('select[name=categoriabiblioteca]').val(), $('input[name=titulobiblioteca]').val(), $('input[name=tagsbiblioteca]').val());
            }
