...
//                    }
    ...
    public function ajaxListAme()
    {
        ...
        $this->db->select('b.data_selecao, b.data_requisitante, b.desempenho_perfil');
        ...
        foreach ($output->data as $row) {
            ...
            switch ($row->desempenho_perfil) {
                case 'A':
                    ...
                    break;
                case 'M':
                    $desempenhoPerfil = '<i class="fa fa-smile-o text-warning" style="font-size: 25px;"></i>';
                    break;
                case 'B':
                    $desempenhoPerfil = '<i class="fa fa-smile-o text-danger" style="font-size: 25px;"></i>';
                    break;
            }
            $data[] = [
                $btn,
