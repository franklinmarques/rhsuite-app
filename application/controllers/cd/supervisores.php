...
class Supervisores extends MY_Controller
{
	...
	public function ajax_save()
	{
		...
		if (is_array($id_escolas_manha) == false) {
			$id_escolas_manha = [$id_escolas_manha];
		}
		if (is_array($id_escolas_tarde) == false) {
			$id_escolas_tarde = [$id_escolas_tarde];
		}
		if (is_array($id_escolas_noite) == false) {
			$id_escolas_noite = [$id_escolas_noite];
		}
		$str_escolas_manha = "'" . implode("','", $id_escolas_manha) . "'";
		$str_escolas_tarde = "'" . implode("','", $id_escolas_tarde) . "'";
		$str_escolas_noite = "'" . implode("','", $id_escolas_noite) . "'";
