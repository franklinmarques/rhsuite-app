...
class log_usuarios extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('log_usuarios_model', 'log');
    }
    ...
    public function detalhes()
    {
        ...
        $data = $this->log->selecionar(array('id' => $id));
    ...
    {
        $id = $this->input->post('id');
        $status = $this->log->excluir(array('id' => $id));
    ...
    public function limpar()
    {
        ...
        $status = $this->log->limpar($dataInicio, $dataTermino);
