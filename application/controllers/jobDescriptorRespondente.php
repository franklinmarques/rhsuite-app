...
class JobDescriptorRespondente extends MY_Controller
{
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $apontamento) {
            ...
            $row[] = '
                      <button class="btn btn-sm btn-info" onclick="edit_descritivo(' . $apontamento->id . ')" title="Editar versão de cargo/função"><i class="glyphicon glyphicon-pencil"></i></button>
