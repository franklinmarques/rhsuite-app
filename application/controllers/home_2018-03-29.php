...
class Home extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('tipo') == "administrador") {
            ...
            $data['usuarios'] = $this->db->query('SELECT * FROM recrutamento_usuarios WHERE empresa = ?', $this->session->userdata('empresa'));
            $this->load->view('index_candidato', $data);
        }
    }
...
//        $data['confirmarsenha'] = trim($_POST['confirmarsenha']);
    ...
    public function editarempresa_json()
    {
        ...
        if ($data['max_colaboradores'] < $max_colaboradores) {
...
*/
    ...
    {
        $funcionario = $this->db->query("SELECT * FROM usuarios WHERE tipo = ? AND id = ?", array("funcionario", $this->uri->rsegment(3)))->row(0);
