...
class Apontamento_eventos extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('apontamento_eventos', $data);
    }
    ...
    public function pdf()
    {
        ...
        $this->m_pdf->pdf->writeHTML($this->load->view('apontamento_eventosPdf', $data, true));
