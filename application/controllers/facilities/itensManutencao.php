...
class ItensManutencao extends MY_Controller
{
    ...
    public function gerenciar()
    {
        ...
        $this->load->view('facilities/itens_manutencao', $data);
    }
    ...
    public function ajaxList()
    {
        ...
        foreach ($rows as $row) {
            $data[] = array(
                $row->nome,
                '<button class="btn btn-sm btn-info" onclick="edit_manutencao(' . $row->id . ')" title="Editar item de manutenção periódica de facilities"><i class="glyphicon glyphicon-pencil"></i></button>
                 <button class="btn btn-sm btn-danger" onclick="delete_manutencao(' . $row->id . ')" title="Excluir item de manutenção periódica de facilities"><i class="glyphicon glyphicon-trash"></i></button>'
            );
        }
