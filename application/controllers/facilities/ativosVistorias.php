...
class AtivosVistorias extends MY_Controller
{
    ...
    public function gerenciar()
    {
        ...
        $this->load->view('facilities/ativos_vistorias', $data);
    }
    ...
    public function ajaxList()
    {
        ...
        foreach ($rows as $row) {
            $data[] = array(
                $row->nome,
                '<button class="btn btn-sm btn-info" onclick="edit_vistoria(' . $row->id . ')" title="Editar item de vistorias de ativos"><i class="glyphicon glyphicon-pencil"></i></button>
                 <button class="btn btn-sm btn-danger" onclick="delete_vistoria(' . $row->id . ')" title="Excluir item de vistorias de ativos"><i class="glyphicon glyphicon-trash"></i></button>'
            );
        }
