...
//            $saldoAcumulado -= $saldoMes;
    ...
    public function ajaxEditTotalizacao()
    {
        ...
        $this->db->select("'{$idMes}' AS mes, f.observacoes_mes{$idMes} AS observacoes", false);
...
//--------------------------------------------------------------------------
    ...
    public function planilhaPagamentoPrestador($idHorario, $idMes, $ano, $is_pdf = false, $recuperar = false)
    {
        ...
        $this->db->select('d.nome AS cuidador, a3.nome AS solicitante, a.depto', false);
        ...
        $this->db->select("FORMAT(c2.valor_hora_operacional, 2, 'de_DE') AS valor_hora_operacional", false);
