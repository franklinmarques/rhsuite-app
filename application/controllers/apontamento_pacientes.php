    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $apontamento) {
            ...
            $row[] = '
                      ...
                      <a class="btn btn-sm btn-success" href="' . site_url('apontamento_pacientes/frequencia/' . $apontamento->id) . '" title="Ver processo"><i class="glyphicon glyphicon-list"></i> Gerar controle de frequência individual</a>
                      <a class="btn btn-sm btn-info" href="' . site_url('apontamento_pacientes/relatorio/' . $apontamento->id) . '" title="Ver processo"><i class="glyphicon glyphicon-list-alt"></i> Relatório</a>
                     ';
            $data[] = $row;
        }
