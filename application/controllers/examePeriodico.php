...
class ExamePeriodico extends MY_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('usuarios_exame_periodico_model', 'exame');
	}
	...
	public function ajax_add()
	{
		...
		$this->exame->insert($data) or exit(json_encode(['retorno' => 0, 'aviso' => $this->exame->errors()]));
...
//		$this->enviarEmail(false);
	...
	{
		$this->exame->delete($this->input->post('id')) or exit(json_encode(['retorno' => 0, 'aviso' => $this->exame->errors()]));
	...
	public function limpar()
	{
		...
		$this->exame->where(['id_usuario' => $id_usuario])->delete() or exit(json_encode(['retorno' => 0, 'aviso' => $this->exame->errors()]));
