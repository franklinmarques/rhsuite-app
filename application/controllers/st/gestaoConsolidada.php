...
class GestaoConsolidada extends MY_Controller
{
    ...
    public function gerenciar($pdf = false)
    {
        ...
        if ($pdf) {
            ...
            return $this->load->view('st/gestao_consolidadaPdf', $data, true);
        } else {
            $this->load->view('st/gestao_consolidada', $data);
        }
    }
