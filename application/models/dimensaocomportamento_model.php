...
class Dimensaocomportamento_model extends CI_Model
{
    ...
    public function carregaComboCompetencia($id)
    {
										...
										competencias.nome as nome_competencia 
											FROM cargos 
												LEFT JOIN competencias ON cargos.id = competencias.id_cargo 
													WHERE competencias.id = {$id} AND competencias.tipo_competencia =1");
