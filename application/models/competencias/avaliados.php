    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="btn btn-sm btn-success" href="<?= site_url('competencias/avaliados/novo/' . $id_competencia); ?>" title="Adicionar Avaliados" ><i class="glyphicon glyphicon-plus"></i>Adicionar avaliados e avaliadores</a>
