...
class Dimensao_model extends CI_Model
{

    var $table = 'comportamento_dimensao';
    ...
    {
        $sql = "SELECT cargos.id AS id_cargo,
                       cargos.nome AS nome_cargo, 
                       competencias.id AS id_competencia, 
                       competencias.nome AS nome_competencia 
                FROM cargos 
                LEFT JOIN competencias ON 
                          cargos.id = competencias.id_cargo 
                WHERE competencias.id = {$id} AND 
