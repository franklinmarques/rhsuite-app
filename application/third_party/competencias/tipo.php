        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb" style="margin-bottom: 5px;">
                    <li><a href="<?= site_url("competencias/cargos/") ?>">Cargo-função: </a> <?= $options_cargos['cargo_funcao'] ?></li>
                    <li class="active">Competência <?= $nome_tipo ?></li>
                </ol>
                <div class="row form-inline">
                    <div class="col-sm-6 col-md-5">
                        <button class="btn btn-success" onclick="add_competencias()"><i class="glyphicon glyphicon-plus"></i> Adicionar competência <?= $nome_tipo ?></button>
                ...
                <div class="modal-content" style="width: 990px">
                    ...
                    <div class="modal-body form">
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <input type="hidden" name="id_cargo" id="id_cargo" value="<?= $options_cargos['id_cargo'] ?>">
                            <input type="hidden" name="id_modelo" id="id_modelo"/>
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">Cargo/função</label>
                                    <div class="col-md-9">
                                        <label class="sr-only" style="margin-top: 7px;"><?= $options_cargos['cargo_funcao'] ?></label>
                                ...
                                <div class="form-group input_competencia">
                                    <div class="col-md-7">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <input id="nome" name="nome" placeholder="Digite a competência " class="form-control" type="text">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <?php if ($tipo): ?>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="tipo_competencia" class="tipo_competencia" value="T"> Técnica
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="tipo_competencia" class="tipo_competencia" value="C"> Comportamental
                                                    </label>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                                ...
                                                <div style="overflow-x: hidden;overflow-y: scroll; height: 170px">
                                                    <ul id="sugestao" class="list-group">
                                                        <?php foreach ($competencias_sugestao as $k => $sugestao): ?>
                                                            <li id="<?= $sugestao->id ?>"style="cursor:pointer;" class="sugestao_competencia list-group-item" data-tipo="<?= $sugestao->tipo ?>"><?= $sugestao->nome ?></li>
                                                        <?php endforeach; ?>	
                                                    </ul>
                                                    <span class="help-block"></span>
                                                </div>
    ...
    function edit_competencias(id)
    {
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                $('#tipo_competencia').val(data.tipo_competencia);
                $('.tipo_competencia').val([data.tipo_competencia]);
