    ...
    <section class="wrapper">   
        ...
        <div class="row">
            ...
            <div class="col col-md-3 text-right">
                <?php if ($is_pdf == false): ?>
                    <a id="pdf" class="btn btn-sm btn-danger" href="<?= site_url('competencias/relatorios/pdfAndamento/' . $this->uri->rsegment(3)); ?>" title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
            ...
            <div class="row">
                <div class="col col-md-12">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="status" class="status" value="" onchange="filtrar_status()" checked=""> Todos
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="status" class="status" onchange="filtrar_status()" value="avaliado"> Somente avaliados
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="status" class="status" onchange="filtrar_status()" value="avaliar"> Somente a avaliar
                    </label>
                </div>
            </div>
            <br>
            ...
            <div class="col col-md-12">
                ...
                <?php foreach ($dadosAvaliadores as $id => $competencia) : ?>
                    <div class="panel panel-success">
                        <div class="panel-heading" style="color: #3c763d !important; background-color: #dff0d8 !important;"><label><?= $competencia->nome ?></label></div>
