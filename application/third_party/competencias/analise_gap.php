        ...
        <table class="table table-condensed avaliacao">
            ...
            <tbody>
                <tr style='border-top: 5px solid #ddd;'>
                    ...
                    <td class="text-right">
                        <?php if ($is_pdf == false): ?>
                            <a id="pdf" class="btn btn-sm btn-danger" href="<?= site_url('competencias/relatorios/pdfAnaliseGap/' . $this->uri->rsegment(3) . "/" . $this->uri->rsegment(4) . 'q?avaliadores=1'); ?>" title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
                        ...
                        <tr class='text-right'>
                            ...
                            <td>
                                <?php if ($dimensao->colaborador->idcPerc < 0): ?>
                                    <span class="text-danger" style="font-weight: bold;"><?= $dimensao->colaborador->idcPerc; ?></span>
                                <?php elseif ($dimensao->colaborador->idcPerc > 0): ?>
                                    <span class="text-success" style="font-weight: bold;"><?= $dimensao->colaborador->idcPerc; ?></span>
                                <?php else: ?>
