            ...
            <table class="table table-condensed avaliacao">
                ...
                <tbody>
                    <tr style='border-top: 5px solid #ddd;'>
                        ...
                        <td class="text-right">
                            <?php if ($is_pdf == false): ?>
                                <a id="pdf" class="btn btn-sm btn-danger" href="<?= site_url('avaliacao/relatorios/pdfAnalise_comparativa/' . $this->uri->rsegment(3)); ?>" title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                </tbody>
