        ...
        <div class="container-fluid">
            <table class="table table-condensed cargo">
                ...
                <tbody>
                    <tr style='border-top: 5px solid #ddd;'>
                        <td>
                            <?php if ($is_pdf == false): ?>
                                <h5><strong>Cargo/função: </strong><?= $cargo ?></h5>
                                <h5><strong>Data atual: </strong><?= $data_atual ?></h5>
                            <?php else: ?>
                                <h6><strong>Cargo/função: </strong><?= $cargo ?></h6>
                                <h6><strong>Data atual: </strong><?= $data_atual ?></h6>
                            <?php endif; ?>
                        </td>
                        <td class="text-right">
                            <?php if ($is_pdf == false): ?>
                                <a class="btn btn-sm btn-danger" href="<?= site_url('avaliacao/cargos/pdfCompetencias/' . $this->uri->rsegment(3) . "/" . $this->uri->rsegment(4)); ?>" title="Exportar PDF"><i class="glyphicon glyphicon-download-alt"></i> Exportar PDF</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="bg-info text-info" type="none">
                                ...
                                <li><small>IDC - Índice de Desempenho apresentado pelo Colaborador</small></li>
                                <li><small>IDc - Índice de Desempenho Geral do colaborador frente &nbsp; | &nbsp; IDC% - GAP Percentual (IDC / IDCf)</small></li>
                            </ul>
            ...
            <?php foreach ($ct as $competencia): ?>
                ...
                <table class="competencias table table-bordered table-condensed">
                    <thead>
                        <tr class='success'>
                            <th colspan="6" class='text-success'><?= $competencia['nome'] ?></th>
                        </tr>
                        <tr class='active'>
